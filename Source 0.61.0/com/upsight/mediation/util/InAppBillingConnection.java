...
public class InAppBillingConnection {
    ...
    class C12311 implements ServiceConnection {
        C12311() {
        }
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                ...
                FuseLog.m606e("Fuse-InAppBillingConnection", "Exception thrown while attempting to retrieve IInAppBillingService", t);
                InAppBillingConnection.this.closeConnection();
    ...
    class C12322 extends ArrayList<String> {
    ...
    public String getLocalPriceForProductId(@NonNull String productId) {
        ...
        new Bundle().putStringArrayList("ITEM_ID_LIST", new C12322(productId));
        try {
            ...
            FuseLog.m606e("Fuse-InAppBillingConnection", "Exception thrown while getting SKU Details", t);
        }
        return null;
    }
}
