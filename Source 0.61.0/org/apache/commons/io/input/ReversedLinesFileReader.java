...
public class ReversedLinesFileReader implements Closeable {
    ...
    public ReversedLinesFileReader(File file) throws IOException {
        this(file, (int) MpegAudioHeader.MAX_FRAME_SIZE_BYTES, Charset.defaultCharset().toString());
    }
    ...
    public ReversedLinesFileReader(File file, int blockSize, Charset encoding) throws IOException {
        ...
        if (charset.newEncoder().maxBytesPerChar() == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
            this.byteDecrement = 1;
        } else if (charset == Charset.forName(C0277C.UTF8_NAME)) {
            this.byteDecrement = 1;
