...
public final class OperatorElementAt<T> implements Operator<T, T> {
    ...
    class C14441 extends Subscriber<T> {
        private int currentIndex;
        final /* synthetic */ Subscriber val$child;

        C14441(Subscriber subscriber) {
    ...
    static class InnerProducer extends AtomicBoolean implements Producer {
        ...
        public void request(long n) {
            if (n < 0) {
                ...
                this.actual.request(PtsTimestampAdjuster.DO_NOT_OFFSET);
            }
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        Subscriber<T> parent = new C14441(child);
        child.add(parent);
        return parent;
    }
}
