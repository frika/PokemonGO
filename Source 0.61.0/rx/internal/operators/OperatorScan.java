...
public final class OperatorScan<R, T> implements Operator<R, T> {
    ...
    class C14831 implements Func0<R> {
    ...
    class C14842 extends Subscriber<T> {
        boolean once;
        final /* synthetic */ Subscriber val$child;
        R value;

        C14842(Subscriber x0, Subscriber subscriber) {
    ...
    class C14853 extends Subscriber<T> {
        final /* synthetic */ Object val$initialValue;
        final /* synthetic */ InitialProducer val$ip;
        private R value;

        C14853(Object obj, InitialProducer initialProducer) {
            this.val$initialValue = obj;
    ...
    static final class InitialProducer<R> implements Producer, Observer<R> {
        ...
        public void setProducer(Producer p) {
            ...
            synchronized (this.requested) {
                ...
                if (mr != PtsTimestampAdjuster.DO_NOT_OFFSET) {
                    mr--;
                }
    ...
    public OperatorScan(R initialValue, Func2<R, ? super T, R> accumulator) {
        this(new C14831(initialValue), (Func2) accumulator);
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        ...
        if (initialValue == NO_INITIAL_VALUE) {
            return new C14842(child, child);
        }
        InitialProducer<R> ip = new InitialProducer(initialValue, child);
        Subscriber<? super T> parent = new C14853(initialValue, ip);
        child.add(parent);
