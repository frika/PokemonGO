...
public final class SingleOnSubscribeDelaySubscriptionOther<T> implements OnSubscribe<T> {
    ...
    class C15451 extends SingleSubscriber<T> {
        final /* synthetic */ SingleSubscriber val$subscriber;

        C15451(SingleSubscriber singleSubscriber) {
    ...
    class C15462 extends Subscriber<Object> {
        boolean done;
        final /* synthetic */ SingleSubscriber val$child;
        final /* synthetic */ SerialSubscription val$serial;

        C15462(SingleSubscriber singleSubscriber, SerialSubscription serialSubscription) {
    ...
    public void call(SingleSubscriber<? super T> subscriber) {
        SingleSubscriber<T> child = new C15451(subscriber);
        SerialSubscription serial = new SerialSubscription();
        subscriber.add(serial);
        Subscriber otherSubscriber = new C15462(child, serial);
