...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C01271 implements MainThreadCallback<T> {
        ...
        class C01261 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C01271.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C01271.UPDATE_ITEM_COUNT /*1*/:
                            C01271.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C01271.ADD_TILE /*2*/:
                            C01271.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C01271.REMOVE_TILE /*3*/:
                            C01271.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C01271.this.mQueue.next();
                }
            }
        }

        C01271(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01261();
        }
    ...
    class C01292 implements BackgroundCallback<T> {
        ...
        class C01281 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C01292.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C01292.REFRESH /*1*/:
                                C01292.this.mQueue.removeMessages(C01292.REFRESH);
                                C01292.this.val$callback.refresh(msg.arg1);
                                break;
                            case C01292.UPDATE_RANGE /*2*/:
                                C01292.this.mQueue.removeMessages(C01292.UPDATE_RANGE);
                                C01292.this.mQueue.removeMessages(C01292.LOAD_TILE);
                                C01292.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C01292.LOAD_TILE /*3*/:
                                C01292.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C01292.RECYCLE_TILE /*4*/:
                                C01292.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C01292.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C01292(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01281();
        }
