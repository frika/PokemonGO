...
public final class BillboardFragment extends DialogFragment {
    ...
    class C11701 implements OnKeyListener {
        C11701() {
        }
    ...
    static /* synthetic */ class C11712 {
        static final /* synthetic */ int[] f724x3f5ad3de;

        static {
            f724x3f5ad3de = new int[LayoutOrientation.values().length];
            try {
                f724x3f5ad3de[LayoutOrientation.Portrait.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f724x3f5ad3de[LayoutOrientation.Landscape.ordinal()] = 2;
        ...
        if (dimensions != null) {
            for (Dimensions dimension : dimensions) {
                if (dimension.width > 0 && dimension.height > 0) {
                    switch (C11712.f724x3f5ad3de[dimension.layout.ordinal()]) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (this.mContentViewContainer != null) {
            this.mRootView = (ViewGroup) inflater.inflate(C1162R.layout.upsight_fragment_billboard, container, false);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setOnKeyListener(new C11701());
        return dialog;
    }
