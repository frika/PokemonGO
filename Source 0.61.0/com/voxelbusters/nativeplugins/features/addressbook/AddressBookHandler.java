...
public class AddressBookHandler {
    ...
    static {
        ...
        DISPLAY_NAME = VERSION.SDK_INT >= 11 ? PHONE_DISPLAY_NAME : PHONE_DISPLAY_NAME;
    ...
    public void readContacts() {
        new Thread(new C12521()).start();
    }

    public void addContact(String contactDataJsonStr) {
        new Thread(new C12532(JSONUtility.getJSON(contactDataJsonStr))).start();
    }
