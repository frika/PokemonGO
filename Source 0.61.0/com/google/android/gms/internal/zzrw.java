...
public final class zzrw {
    ...
    public String readString() throws IOException {
        int zzFv = zzFv();
        if (zzFv > this.zzbib - this.zzbid || zzFv <= 0) {
            return new String(zzlF(zzFv), C0277C.UTF8_NAME);
        }
        String str = new String(this.buffer, this.zzbid, zzFv, C0277C.UTF8_NAME);
        this.zzbid = zzFv + this.zzbid;
        return str;
    }
    ...
    public int zzFv() throws IOException {
        ...
        i |= (zzFC2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 21;
        zzFC2 = zzFC();
        i |= zzFC2 << 28;
        if (zzFC2 >= null) {
            return i;
    ...
    public int zzFx() throws IOException {
        return (((zzFC() & NalUnitUtil.EXTENDED_SAR) | ((zzFC() & NalUnitUtil.EXTENDED_SAR) << 8)) | ((zzFC() & NalUnitUtil.EXTENDED_SAR) << 16)) | ((zzFC() & NalUnitUtil.EXTENDED_SAR) << 24);
    }
