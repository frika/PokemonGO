...
public final class OperatorMapPair<T, U, R> implements Operator<Observable<? extends R>, T> {
    ...
    static class C14501 implements Func1<T, Observable<U>> {
    ...
    class C14522 extends Subscriber<T> {
        ...
        C14522(Subscriber x0, Subscriber subscriber) {
        ...
        public void onNext(T outer) {
            try {
                this.val$o.onNext(((Observable) OperatorMapPair.this.collectionSelector.call(outer)).map(new C14511(outer)));
            } catch (Throwable e) {
