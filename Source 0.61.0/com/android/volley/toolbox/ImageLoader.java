...
public class ImageLoader {
    ...
    class C01712 implements Listener<Bitmap> {
    ...
    class C01723 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    class C01734 implements Runnable {
        C01734() {
        }
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C01701(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C01712(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C01723(cacheKey));
    }
