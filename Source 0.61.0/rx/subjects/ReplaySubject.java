...
public final class ReplaySubject<T> extends Subject<T, T> {
    ...
    static class C16161 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C16161(UnboundedReplayState unboundedReplayState) {
    ...
    static class C16172 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C16172(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
    ...
    static class C16183 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C16183(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
    ...
    static class C16194 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C16194(BoundedState boundedState) {
    ...
    static class C16205 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C16205(BoundedState boundedState) {
            this.val$state = boundedState;
        }
    ...
    public static <T> ReplaySubject<T> create(int capacity) {
        ...
        ssm.onStart = new C16161(state);
        ssm.onAdded = new C16172(state);
        ssm.onTerminated = new C16183(state);
    ...
    static <T> ReplaySubject<T> createWithState(BoundedState<T> state, Action1<SubjectObserver<T>> onStart) {
        SubjectSubscriptionManager<T> ssm = new SubjectSubscriptionManager();
        ssm.onStart = onStart;
        ssm.onAdded = new C16194(state);
        ssm.onTerminated = new C16205(state);
        return new ReplaySubject(ssm, ssm, state);
    }
