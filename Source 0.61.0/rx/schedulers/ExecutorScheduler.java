...
final class ExecutorScheduler extends Scheduler {
    ...
    static final class ExecutorSchedulerWorker extends Worker implements Runnable {
        ...
        class C16071 implements Action0 {
            final /* synthetic */ MultipleAssignmentSubscription val$mas;

            C16071(MultipleAssignmentSubscription multipleAssignmentSubscription) {
        ...
        class C16082 implements Action0 {
            final /* synthetic */ Action0 val$action;
            final /* synthetic */ MultipleAssignmentSubscription val$mas;
            final /* synthetic */ Subscription val$removeMas;

            C16082(MultipleAssignmentSubscription multipleAssignmentSubscription, Action0 action0, Subscription subscription) {
                this.val$mas = multipleAssignmentSubscription;
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            ...
            mas.set(first);
            this.tasks.add(mas);
            Subscription removeMas = Subscriptions.create(new C16071(mas));
            ScheduledAction ea = new ScheduledAction(new C16082(mas, action, removeMas));
            first.set(ea);
            try {
