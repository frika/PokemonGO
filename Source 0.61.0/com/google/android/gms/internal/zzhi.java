...
public class zzhi extends zzhz implements zzhj, zzhm {
    ...
    class C07261 implements Runnable {
        ...
        C07261(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel) {
    ...
    class C07272 implements Runnable {
        ...
        C07272(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel, zzhl com_google_android_gms_internal_zzhl) {
            this.zzHl = com_google_android_gms_internal_zzhi;
            this.zzHk = com_google_android_gms_internal_zzen;
            this.zzpe = adRequestParcel;
        ...
        if (this.zzHg != null && this.zzHg.zzgd() != null && this.zzHg.zzgc() != null) {
            ...
            try {
                if (zzgc.isInitialized()) {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new C07261(this, zzgc, adRequestParcel));
                } else {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new C07272(this, zzgc, adRequestParcel, zzgd));
                }
            } catch (Throwable e) {
    ...
    protected boolean zzf(long j) {
        long elapsedRealtime = HlsChunkSource.DEFAULT_MAX_BUFFER_TO_SWITCH_DOWN_MS - (zzp.zzbz().elapsedRealtime() - j);
