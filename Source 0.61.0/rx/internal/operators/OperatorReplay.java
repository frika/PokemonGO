...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
    ...
    static class C14691 implements Func0 {
        C14691() {
        }
    ...
    static class C14712 implements OnSubscribe<R> {
        ...
        class C14701 implements Action1<Subscription> {
            final /* synthetic */ Subscriber val$child;

            C14701(Subscriber subscriber) {
        ...
        C14712(Func0 func0, Func1 func1) {
    ...
    static class C14733 implements OnSubscribe<T> {
        final /* synthetic */ Observable val$observable;

        /* renamed from: rx.internal.operators.OperatorReplay.3.1 */
        class C14721 extends Subscriber<T> {
            final /* synthetic */ Subscriber val$child;

            C14721(Subscriber x0, Subscriber subscriber) {
                this.val$child = subscriber;
                super(x0);
            }
        ...
        C14733(Observable observable) {
            this.val$observable = observable;
        }

        public void call(Subscriber<? super T> child) {
            this.val$observable.unsafeSubscribe(new C14721(child, child));
        }
    }

    /* renamed from: rx.internal.operators.OperatorReplay.4 */
    static class C14744 extends ConnectableObservable<T> {
        final /* synthetic */ ConnectableObservable val$co;

        C14744(OnSubscribe x0, ConnectableObservable connectableObservable) {
    ...
    static class C14755 implements Func0<ReplayBuffer<T>> {
    ...
    static class C14766 implements Func0<ReplayBuffer<T>> {
        final /* synthetic */ int val$bufferSize;
        final /* synthetic */ long val$maxAgeInMillis;
        final /* synthetic */ Scheduler val$scheduler;

        C14766(int i, long j, Scheduler scheduler) {
            this.val$bufferSize = i;
    ...
    static class C14777 implements OnSubscribe<T> {
        final /* synthetic */ Func0 val$bufferFactory;
        final /* synthetic */ AtomicReference val$curr;

        C14777(AtomicReference atomicReference, Func0 func0) {
        ...
        public final void replay(InnerProducer<T> output) {
            synchronized (output) {
                ...
                while (!output.isUnsubscribed()) {
                    long r = output.get();
                    boolean unbounded = r == PtsTimestampAdjuster.DO_NOT_OFFSET;
                    long e = 0;
            ...
            if (n >= 0) {
                ...
                do {
                    ...
                    if (r < 0 || n != 0) {
                        u = r + n;
                        if (u < 0) {
                            u = PtsTimestampAdjuster.DO_NOT_OFFSET;
                        }
                    } else {
                        return;
                    }
    ...
    static final class ReplaySubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        class C14781 implements Action0 {
            C14781() {
            }
        ...
        void init() {
            add(Subscriptions.create(new C14781()));
        }
            ...
            synchronized (output) {
                ...
                while (!output.isUnsubscribed()) {
                    ...
                    if (e != 0) {
                        ...
                        if (r0 != PtsTimestampAdjuster.DO_NOT_OFFSET) {
                            output.produced(e);
                        }
                    }
                    synchronized (output) {
    ...
    static {
        DEFAULT_UNBOUNDED_FACTORY = new C14691();
    }
    ...
    public static <T, U, R> Observable<R> multicastSelector(Func0<? extends ConnectableObservable<U>> connectableFactory, Func1<? super Observable<U>, ? extends Observable<R>> selector) {
        return Observable.create(new C14712(connectableFactory, selector));
    }

    public static <T> ConnectableObservable<T> observeOn(ConnectableObservable<T> co, Scheduler scheduler) {
        return new C14744(new C14733(co.observeOn(scheduler)), co);
    }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source, int bufferSize) {
        ...
        return create((Observable) source, new C14755(bufferSize));
    }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source, long maxAge, TimeUnit unit, Scheduler scheduler, int bufferSize) {
        return create((Observable) source, new C14766(bufferSize, unit.toMillis(maxAge), scheduler));
    }
    ...
    static <T> ConnectableObservable<T> create(Observable<? extends T> source, Func0<? extends ReplayBuffer<T>> bufferFactory) {
        ...
        return new OperatorReplay(new C14777(curr, bufferFactory), source, curr, bufferFactory);
    }
