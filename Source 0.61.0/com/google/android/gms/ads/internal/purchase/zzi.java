...
public class zzi {
    ...
    class C03501 implements ServiceConnection {
        final /* synthetic */ zzi zzDa;
        final /* synthetic */ Context zzry;

        C03501(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
    ...
    public void zzx(Context context) {
        ServiceConnection c03501 = new C03501(this, context);
        Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
        context.bindService(intent, c03501, 1);
    }
}
