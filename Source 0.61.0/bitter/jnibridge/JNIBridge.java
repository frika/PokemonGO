...
public class JNIBridge {
    ...
    private static class C0162a implements InvocationHandler {
        private Object f5a;
        private long f6b;
    ...
    static void disableInterfaceProxy(Object obj) {
        ((C0162a) Proxy.getInvocationHandler(obj)).m15a();
    }
    ...
    static Object newInterfaceProxy(long j, Class[] clsArr) {
        return Proxy.newProxyInstance(JNIBridge.class.getClassLoader(), clsArr, new C0162a(j));
    }
}
