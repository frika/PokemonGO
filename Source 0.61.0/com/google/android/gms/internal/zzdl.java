...
public class zzdl implements zzdk {
    ...
    class C06631 implements Runnable {
        ...
        class C06621 implements Runnable {
            ...
            final /* synthetic */ C06631 zzxE;

            C06621(C06631 c06631, JSONObject jSONObject) {
                this.zzxE = c06631;
        ...
        C06631(zzdl com_google_android_gms_internal_zzdl, Map map, zziz com_google_android_gms_internal_zziz) {
        ...
        public void run() {
            ...
            if (zzX == null) {
                com.google.android.gms.ads.internal.util.client.zzb.m483e("Response should not be null.");
            } else {
                zzid.zzIE.post(new C06621(this, zzX));
            }
        }
    }
    ...
    public JSONObject zzX(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m483e("The request is not a valid JSON.");
            try {
    ...
    public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
        zzic.zza(new C06631(this, map, com_google_android_gms_internal_zziz));
    }
