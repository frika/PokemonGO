...
public class MRAIDNativeFeatureManager {
    ...
    public boolean isCalendarSupported() {
        ...
        MRAIDLog.m618v(TAG, "isCalendarSupported " + retval);
        return retval;
    }
    ...
    public boolean isInlineVideoSupported() {
        ...
        MRAIDLog.m618v(TAG, "isInlineVideoSupported " + retval);
        return retval;
    }
    ...
    public boolean isSmsSupported() {
        ...
        MRAIDLog.m618v(TAG, "isSmsSupported " + retval);
        return retval;
    }
    ...
    public boolean isStorePictureSupported() {
        ...
        MRAIDLog.m618v(TAG, "isStorePictureSupported " + retval);
        return retval;
    }
    ...
    public boolean isTelSupported() {
        ...
        MRAIDLog.m618v(TAG, "isTelSupported " + retval);
        return retval;
    }
}
