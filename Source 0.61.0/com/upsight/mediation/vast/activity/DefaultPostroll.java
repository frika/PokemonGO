...
public class DefaultPostroll extends RelativeLayout implements Postroll {
    ...
    private void setUpLayerOfDarkness(Context c) {
        ...
        this.mLayerOfDarkness.setBackgroundColor(Color.argb(PsExtractor.AUDIO_STREAM, 0, 0, 0));
    ...
    private void setUpLearn(Context c) {
        if (this.mShouldShowActionButton) {
            ...
            this.mLearnButton.setOnClickListener(new C12361());
    ...
    private void setUpX(Context c) {
        ...
        Assets.setAlpha(this.mXButtonView, DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD);
        ...
        this.mXButtonView.setOnClickListener(new C12372());
