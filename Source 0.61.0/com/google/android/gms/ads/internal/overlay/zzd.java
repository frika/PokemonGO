...
public class zzd extends com.google.android.gms.internal.zzfk.zza implements zzo {
    ...
    class C03471 implements com.google.android.gms.internal.zzja.zza {
        final /* synthetic */ zzd zzBv;

        C03471(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzhz {
        ...
        class C03481 implements Runnable {
            ...
            C03481(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbn() {
            ...
            if (zzg != null) {
                zzid.zzIE.post(new C03481(this, zzp.zzbx().zza(this.zzBv.mActivity, zzg, this.zzBv.zzBi.zzBM.zzpw, this.zzBv.zzBi.zzBM.zzpx)));
            }
        }
    }
    ...
    protected void zzv(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzoM.zzhe().zza(new C03471(this));
            if (this.zzBi.url != null) {
                this.zzoM.loadUrl(this.zzBi.url);
            } else if (this.zzBi.zzBH != null) {
                this.zzoM.loadDataWithBaseURL(this.zzBi.zzBF, this.zzBi.zzBH, Mime.HTML_TEXT, C0277C.UTF8_NAME, null);
            } else {
