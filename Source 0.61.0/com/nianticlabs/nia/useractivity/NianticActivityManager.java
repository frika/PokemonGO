...
public class NianticActivityManager extends ContextService {
    ...
    class C09701 implements Listener {
        C09701() {
        }
    ...
    class C09712 implements Runnable {
        ...
        C09712(ActivityRecognitionResult activityRecognitionResult) {
    ...
    public NianticActivityManager(Context context, long nativeClassPointer) {
        ...
        this.googleApiListener = new C09701();
    ...
    public static PendingIntent createPendingIntent(Context context) {
        return PendingIntent.getService(context, 0, new Intent(context, ActivityRecognitionService.class), C0277C.SAMPLE_FLAG_DECODE_ONLY);
    }
    ...
    public void receiveUpdateActivity(ActivityRecognitionResult result) {
        ContextService.runOnServiceHandler(new C09712(result));
    }
