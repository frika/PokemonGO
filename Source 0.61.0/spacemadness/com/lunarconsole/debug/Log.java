...
public class Log {
    ...
    public static void m630i(String format, Object... args) {
        m631i(null, format, args);
    }

    public static void m631i(Tag tag, String format, Object... args) {
        log(LogLevel.Info, tag, format, args);
    }

    public static void m632w(String format, Object... args) {
        m633w(null, format, args);
    }

    public static void m633w(Tag tag, String format, Object... args) {
        log(LogLevel.Warn, tag, format, args);
    }

    public static void m625d(String format, Object... args) {
        m626d(null, format, args);
    }

    public static void m626d(Tag tag, String format, Object... args) {
        log(LogLevel.Debug, tag, format, args);
    }

    public static void m629e(Tag tag, String format, Object... args) {
        log(LogLevel.Error, tag, format, args);
    }

    public static void m627e(String format, Object... args) {
        m629e((Tag) null, format, args);
    }

    public static void m628e(Throwable t, String format, Object... args) {
        m627e(format, args);
        if (t != null) {
            t.printStackTrace();
        }
