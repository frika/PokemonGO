...
public abstract class GcmListenerService extends Service {
    ...
    class C06051 implements Runnable {
        ...
        C06051(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C06062 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaCg;

        C06062(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaCg = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    L_0x003e:
        r1 = r4.zzpd;	 Catch:{ all -> 0x0085 }
        monitor-enter(r1);	 Catch:{ all -> 0x0085 }
        r0 = r4.zzaCf;	 Catch:{ all -> 0x00a8 }
        r0 = r0 + -1;
        r4.zzaCf = r0;	 Catch:{ all -> 0x00a8 }
        r0 = r4.zzaCf;	 Catch:{ all -> 0x00a8 }
        if (r0 != 0) goto L_0x0050;
    L_0x004b:
        r0 = r4.zzaCe;	 Catch:{ all -> 0x00a8 }
        r4.zzgA(r0);	 Catch:{ all -> 0x00a8 }
    L_0x0050:
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C06051(this, intent));
        } else {
            new C06062(this, intent).execute(new Void[0]);
        }
        return 3;
    }
