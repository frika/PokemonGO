...
class DataStore implements UpsightDataStore {
    ...
    class C11201 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11201(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11212 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11212(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11223 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11223(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11234 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11234(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11245 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11245(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11256 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11256(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11267 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11267(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11278 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11278(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C11289 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C11289(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, UpsightDataStoreListener<Set<T>> listener) {
        if (clazz == null) {
            ...
            return Subscriptions.from(fetchObservable(clazz).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C11201(listener), new C11212(listener)));
        } else {
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(fetchObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C11223(listener), new C11234(listener)));
    }

    public <T> UpsightSubscription remove(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(removeObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C11245(listener), new C11256(listener)));
    }
    ...
    public <T> UpsightSubscription store(T object, UpsightDataStoreListener<T> listener) {
        return Subscriptions.from(storeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C11267(listener), new C11278(listener)));
    }
    ...
    public <T> UpsightSubscription remove(T object, UpsightDataStoreListener<T> listener) {
        if (listener != null) {
            return Subscriptions.from(removeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C11289(listener), new AnonymousClass10(listener)));
        }
