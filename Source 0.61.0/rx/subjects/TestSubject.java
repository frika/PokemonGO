...
public final class TestSubject<T> extends Subject<T, T> {
    ...
    static class C16231 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ SubjectSubscriptionManager val$state;

        C16231(SubjectSubscriptionManager subjectSubscriptionManager) {
    ...
    class C16242 implements Action0 {
        C16242() {
        }
    ...
    class C16253 implements Action0 {
    ...
    class C16264 implements Action0 {
    ...
    public static <T> TestSubject<T> create(TestScheduler scheduler) {
        ...
        state.onAdded = new C16231(state);
    ...
    public void onCompleted(long delayTime) {
        this.innerScheduler.schedule(new C16242(), delayTime, TimeUnit.MILLISECONDS);
    }
    ...
    public void onError(Throwable e, long delayTime) {
        this.innerScheduler.schedule(new C16253(e), delayTime, TimeUnit.MILLISECONDS);
    }
    ...
    public void onNext(T v, long delayTime) {
        this.innerScheduler.schedule(new C16264(v), delayTime, TimeUnit.MILLISECONDS);
    }
