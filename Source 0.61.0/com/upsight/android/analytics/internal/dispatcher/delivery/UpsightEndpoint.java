...
class UpsightEndpoint {
    ...
    public static class Response {
        ...
        public boolean isOk() {
            return this.statusCode == Callback.DEFAULT_DRAG_ANIMATION_DURATION;
        }
    }
    ...
    public Response send(UpsightRequest request) throws IOException {
        ...
        try {
            String requestBody = this.mGson.toJson((Object) request);
            this.mLogger.m574d(Upsight.LOG_TAG, LOG_TEXT_POSTING + refId + LOG_TEXT_TO + this.mEndpointAddress + LOG_TEXT_REQUEST_BODY + this.mRequestLoggingGson.toJson((Object) request), new Object[0]);
            ...
            if (statusCode == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                String logRespBody;
            ...
            this.mLogger.m574d(Upsight.LOG_TAG, sb.toString(), new Object[0]);
    ...
    private String getVerifiedResponse(HttpURLConnection urlConnection) throws IOException {
        ...
        try {
            ...
            this.mLogger.m577e(Upsight.LOG_TAG, e, "Message signature is not valid Base64. X-US-DIGEST: " + signature, new Object[0]);
            return respBody;
        }
    }
}
