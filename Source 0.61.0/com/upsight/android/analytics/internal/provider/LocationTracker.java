...
final class LocationTracker extends UpsightLocationTracker {
    ...
    class C10911 implements UpsightDataStoreListener<Set<Data>> {
        ...
        public void onFailure(UpsightException exception) {
            LocationTracker.this.mLogger.m577e(LocationTracker.LOG_TAG, exception, "Failed to fetch location data.", new Object[0]);
        }
    }

    /* renamed from: com.upsight.android.analytics.internal.provider.LocationTracker.2 */
    class C10922 implements UpsightDataStoreListener<Set<Data>> {
        C10922() {
        }
        ...
        public void onFailure(UpsightException exception) {
            LocationTracker.this.mLogger.m576e(Upsight.LOG_TAG, "Failed to remove stale location data.", exception);
        }
    }
    ...
    public void track(Data newLocation) {
        this.mDataStore.fetch(Data.class, new C10911(newLocation));
    }

    public void purge() {
        this.mDataStore.fetch(Data.class, new C10922());
    }
}
