...
public final class zzee {
    ...
    public zzee(String str) throws JSONException {
        ...
        if (zzb.zzN(2)) {
            zzb.m484v("Mediation Response JSON: " + jSONObject.toString(2));
        }
        ...
        if (optJSONObject != null) {
            this.zzyX = optJSONObject.optLong("ad_network_timeout_millis", -1);
            this.zzyY = zzp.zzbH().zza(optJSONObject, "click_urls");
            this.zzyZ = zzp.zzbH().zza(optJSONObject, "imp_urls");
            this.zzza = zzp.zzbH().zza(optJSONObject, "nofill_urls");
            long optLong = optJSONObject.optLong("refresh", -1);
            this.zzzc = optLong > 0 ? optLong * 1000 : -1;
            JSONArray optJSONArray = optJSONObject.optJSONArray(NotifyRewards.REWARDS);
