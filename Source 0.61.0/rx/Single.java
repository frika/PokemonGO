...
public class Single<T> {
    ...
    class AnonymousClass19 implements OnSubscribe<T> {
        ...
        class C13331 implements Action0 {
            ...
            class C13321 extends SingleSubscriber<T> {
                C13321() {
                }

                public void onSuccess(T value) {
                    try {
                        C13331.this.val$t.onSuccess(value);
                    } finally {
                        C13331.this.val$w.unsubscribe();
                    }
                }

                public void onError(Throwable error) {
                    try {
                        C13331.this.val$t.onError(error);
                    } finally {
                        C13331.this.val$w.unsubscribe();
                    }
                }
            ...
            C13331(SingleSubscriber singleSubscriber, Worker worker) {
                this.val$t = singleSubscriber;
                this.val$w = worker;
            }

            public void call() {
                SingleSubscriber ssub = new C13321();
                this.val$t.add(ssub);
        ...
        public void call(SingleSubscriber<? super T> t) {
            ...
            t.add(w);
            w.schedule(new C13331(t, w));
        }
    }

    /* renamed from: rx.Single.1 */
    class C13341 implements rx.Observable.OnSubscribe<T> {
        final /* synthetic */ OnSubscribe val$f;

        /* renamed from: rx.Single.1.1 */
        class C13311 extends SingleSubscriber<T> {
            final /* synthetic */ Subscriber val$child;
            final /* synthetic */ SingleDelayedProducer val$producer;

            C13311(SingleDelayedProducer singleDelayedProducer, Subscriber subscriber) {
        ...
        C13341(OnSubscribe onSubscribe) {
        ...
        public void call(Subscriber<? super T> child) {
            ...
            SingleSubscriber<T> ss = new C13311(producer, child);
            child.add(ss);
            this.val$f.call(ss);
        }
    }
    ...
    class AnonymousClass20 implements Operator<T, T> {
        ...
        class C13351 extends Subscriber<T> {
            ...
            C13351(Subscriber x0, boolean x1, Subscriber subscriber) {
        ...
        class C13362 implements CompletableSubscriber {
            final /* synthetic */ Subscriber val$main;
            final /* synthetic */ Subscriber val$serial;

            C13362(Subscriber subscriber, Subscriber subscriber2) {
        ...
        public Subscriber<? super T> call(Subscriber<? super T> child) {
            ...
            Subscriber<T> main = new C13351(serial, false, serial);
            CompletableSubscriber so = new C13362(main, serial);
            serial.add(main);
            child.add(serial);
    ...
    class AnonymousClass21 implements Operator<T, T> {
        ...
        class C13371 extends Subscriber<T> {
            ...
            C13371(Subscriber x0, boolean x1, Subscriber subscriber) {
                this.val$serial = subscriber;
                super(x0, x1);
            }
        ...
        class C13382 extends Subscriber<E> {
            final /* synthetic */ Subscriber val$main;

            C13382(Subscriber subscriber) {
                this.val$main = subscriber;
            }
        ...
        public Subscriber<? super T> call(Subscriber<? super T> child) {
            Subscriber<T> serial = new SerializedSubscriber(child, false);
            Subscriber<T> main = new C13371(serial, false, serial);
            Subscriber<E> so = new C13382(main);
            serial.add(main);
            serial.add(so);
            child.add(serial);
    ...
    class C13412 implements rx.Observable.OnSubscribe<R> {
        final /* synthetic */ Operator val$lift;

        C13412(Operator operator) {
    ...
    static class C13423 implements OnSubscribe<T> {
    ...
    static class C13434 implements OnSubscribe<T> {
        final /* synthetic */ Callable val$func;

        C13434(Callable callable) {
    ...
    static class C13455 implements OnSubscribe<T> {
        final /* synthetic */ Single val$source;

        /* renamed from: rx.Single.5.1 */
        class C13441 extends SingleSubscriber<Single<? extends T>> {
            final /* synthetic */ SingleSubscriber val$child;

            C13441(SingleSubscriber singleSubscriber) {
        ...
        C13455(Single single) {
            this.val$source = single;
        }

        public void call(SingleSubscriber<? super T> child) {
            this.val$source.subscribe(new C13441(child));
        }
    }

    /* renamed from: rx.Single.6 */
    static class C13466 implements FuncN<R> {
    ...
    static class C13477 implements FuncN<R> {
    ...
    static class C13488 implements FuncN<R> {
    ...
    static class C13499 implements FuncN<R> {
    ...
    public final <R> Single<R> lift(Operator<? extends R, ? super T> lift) {
        return new Single(new C13412(lift));
    }
    ...
    public static <T> Single<T> error(Throwable exception) {
        return create(new C13423(exception));
    }
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> source) {
        ...
        return create(new C13455(source));
    }
    ...
    public static <T1, T2, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Func2<? super T1, ? super T2, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2}, new C13466(zipFunction));
    }
    ...
    public static <T1, T2, T3, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Func3<? super T1, ? super T2, ? super T3, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3}, new C13477(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Func4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4}, new C13488(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Single<? extends T5> s5, Func5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4, s5}, new C13499(zipFunction));
    }
    ...
    public final <E> Single<T> takeUntil(Single<? extends E> other) {
        return lift(new Operator<T, T>() {
            ...
            class C13391 extends Subscriber<T> {
                final /* synthetic */ Subscriber val$serial;

                C13391(Subscriber x0, boolean x1, Subscriber subscriber) {
                    this.val$serial = subscriber;
                    super(x0, x1);
                }
            ...
            class C13402 extends SingleSubscriber<E> {
                final /* synthetic */ Subscriber val$main;

                C13402(Subscriber subscriber) {
                    this.val$main = subscriber;
                }
            ...
            public Subscriber<? super T> call(Subscriber<? super T> child) {
                Subscriber<T> serial = new SerializedSubscriber(child, false);
                Subscriber<T> main = new C13391(serial, false, serial);
                SingleSubscriber so = new C13402(main);
                serial.add(main);
                serial.add(so);
                child.add(serial);
                this.val$other.subscribe(so);
