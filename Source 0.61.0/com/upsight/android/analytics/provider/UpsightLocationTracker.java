...
public abstract class UpsightLocationTracker {
    ...
    public static void track(UpsightSessionContext upsight, Data locationData) {
        track(upsight.getUpsightContext(), locationData);
    }

    public static void purge(UpsightSessionContext upsight) {
        purge(upsight.getUpsightContext());
    }
}
