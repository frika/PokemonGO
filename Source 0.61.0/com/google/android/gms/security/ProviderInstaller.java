...
public class ProviderInstaller {
    ...
    static class C08401 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzaUW;
        final /* synthetic */ Context zzry;

        C08401(Context context, ProviderInstallListener providerInstallListener) {
            this.zzry = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener listener) {
        ...
        new C08401(context, listener).execute(new Void[0]);
    }
