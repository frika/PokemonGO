...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewCompat.canScrollVertically(this.mRecyclerView, RecyclerView.VERTICAL) || ViewCompat.canScrollHorizontally(this.mRecyclerView, RecyclerView.VERTICAL)) {
                info.addAction((int) MpegAudioHeader.MAX_FRAME_SIZE_BYTES);
                info.setScrollable(true);
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0123R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0123R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0123R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0123R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0123R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    }
    ...
    static class C01443 implements Interpolator {
        C01443() {
        }
    ...
    class C01454 implements ProcessCallback {
        C01454() {
        }
    ...
    class C01465 implements Callback {
        C01465() {
        }
    ...
    class C01476 implements Callback {
        C01476() {
        }
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (fromScrap && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD)) {
                ...
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | MpegAudioHeader.MAX_FRAME_SIZE_BYTES, holder.getUnmodifiedPayloads()));
                }
            }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, Cue.TYPE_UNSET, Integer.MAX_VALUE, Cue.TYPE_UNSET, Integer.MAX_VALUE);
            postOnAnimation();
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C01443();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01421();
        ...
        this.mItemAnimatorRunner = new C01432();
        this.mViewInfoProcessCallback = new C01454();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0123R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0123R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private String getFullClassName(Context context, String className) {
        if (className.charAt(TOUCH_SLOP_DEFAULT) == FilenameUtils.EXTENSION_SEPARATOR) {
            return context.getPackageName() + className;
        }
        return !className.contains(".") ? RecyclerView.class.getPackage().getName() + FilenameUtils.EXTENSION_SEPARATOR + className : className;
    }

    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C01465());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C01476());
    }
                ...
                while (true) {
                    ...
                    if (!viewHolder.shouldIgnore()) {
                        if (!this.mViewInfoStore.isInPreLayout(viewHolder)) {
                            ...
                            if (!wasHidden) {
                                flags |= MpegAudioHeader.MAX_FRAME_SIZE_BYTES;
                            }
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        int maxPositionPreLayout = Cue.TYPE_UNSET;
