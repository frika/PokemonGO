...
public class RequestQueue {
    ...
    class C09211 implements RequestFilter {
        ...
        if (request.shouldCache()) {
            synchronized (this.mWaitingRequests) {
                ...
                if (this.mWaitingRequests.containsKey(cacheKey)) {
                    ...
                    if (VolleyLog.DEBUG) {
                        VolleyLog.m488v("Request for cacheKey=%s is in flight, putting on hold.", cacheKey);
                    }
                } else {
        ...
        if (request.shouldCache()) {
            synchronized (this.mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    if (VolleyLog.DEBUG) {
                        VolleyLog.m488v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(waitingRequests.size()), cacheKey);
                    }
