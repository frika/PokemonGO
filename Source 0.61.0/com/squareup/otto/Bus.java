...
public class Bus {
    ...
    class C10201 extends ThreadLocal<ConcurrentLinkedQueue<EventWithHandler>> {
        C10201() {
        }
    ...
    class C10212 extends ThreadLocal<Boolean> {
        C10212() {
        }
    ...
    Bus(ThreadEnforcer enforcer, String identifier, HandlerFinder handlerFinder) {
        ...
        this.eventsToDispatch = new C10201();
        this.isDispatching = new C10212();
