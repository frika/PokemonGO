...
public final class OperatorWithLatestFrom<T, U, R> implements Operator<R, T> {
    ...
    class C15421 extends Subscriber<T> {
        final /* synthetic */ AtomicReference val$current;
        final /* synthetic */ SerializedSubscriber val$s;

        C15421(Subscriber x0, boolean x1, AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
    ...
    class C15432 extends Subscriber<U> {
        final /* synthetic */ AtomicReference val$current;
        final /* synthetic */ SerializedSubscriber val$s;

        C15432(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
            this.val$current = atomicReference;
            this.val$s = serializedSubscriber;
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        ...
        Subscriber<T> subscriber = new C15421(s, true, current, s);
        Subscriber<U> otherSubscriber = new C15432(current, s);
        s.add(subscriber);
