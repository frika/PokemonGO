...
public class MRAIDView extends RelativeLayout {
    ...
    class C12201 extends SimpleOnGestureListener {
        C12201() {
        }
    ...
    class C12212 extends WebView {
        ...
        public void onConfigurationChanged(Configuration newConfig) {
            ...
            MRAIDLog.m618v(TAG, "onConfigurationChanged " + (newConfig.orientation == MRAIDView.STATE_DEFAULT ? "portrait" : "landscape"));
        ...
        protected void onVisibilityChanged(View changedView, int visibility) {
            ...
            MRAIDLog.m618v(TAG, "onVisibilityChanged " + MRAIDView.getVisibilityString(visibility));
            if (MRAIDView.this.isInterstitial) {
        ...
        protected void onWindowVisibilityChanged(int visibility) {
            ...
            MRAIDLog.m618v(TAG, "onWindowVisibilityChanged " + MRAIDView.getVisibilityString(visibility) + " (actual " + MRAIDView.getVisibilityString(actualVisibility) + ")");
            if (MRAIDView.this.isInterstitial) {
    ...
    class C12223 implements OnTouchListener {
        C12223() {
        }
    ...
    class C12234 implements Runnable {
    ...
    class C12245 implements Runnable {
        C12245() {
        }
    ...
    class C12266 implements Runnable {
        ...
        class C12251 implements Runnable {
            ...
            public void run() {
                ...
                MRAIDView.this.webViewPart2.loadDataWithBaseURL(MRAIDView.this.baseUrl, this.val$content, Mime.HTML_TEXT, C0277C.UTF8_NAME, null);
        ...
        public void run() {
            String content = MRAIDView.this.getStringFromUrl(this.val$finalUrl);
            if (TextUtils.isEmpty(content)) {
                MRAIDLog.m615i("Could not load part 2 expanded content for URL: " + this.val$finalUrl);
            } else {
                ((Activity) MRAIDView.this.context).runOnUiThread(new C12251(content));
            }
        }
    }

    /* renamed from: com.upsight.mediation.mraid.MRAIDView.7 */
    class C12277 implements Runnable {
        C12277() {
        }
    ...
    class C12288 implements Runnable {
        final /* synthetic */ boolean val$sendCallback;
    ...
    class C12299 implements Runnable {
        final /* synthetic */ boolean val$sendCallback;
    ...
    private class MRAIDWebChromeClient extends WebChromeClient {
        ...
        public boolean onConsoleMessage(ConsoleMessage cm) {
            if (!cm.message().contains("Uncaught ReferenceError")) {
                MRAIDLog.m616i("JS console", cm.message() + (cm.sourceId() == null ? BuildConfig.FLAVOR : " at " + cm.sourceId()) + UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR + cm.lineNumber());
            }
            return true;
        }

        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            MRAIDLog.m618v("JS alert", message);
            return handlePopups(result);
        }

        public boolean onJsConfirm(WebView view, String url, String message, JsResult result) {
            MRAIDLog.m618v("JS confirm", message);
            return handlePopups(result);
        }

        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
            MRAIDLog.m618v("JS prompt", message);
            return handlePopups(result);
        }
    ...
    private class MRAIDWebViewClient extends WebViewClient {
        ...
        class C12301 implements Runnable {
            ...
            public void run() {
                ...
                MRAIDLog.m618v(MRAIDView.TAG, "calling fireStateChangeEvent 2");
                MRAIDView.this.fireStateChangeEvent();
        ...
        public void onPageFinished(WebView view, String url) {
            MRAIDLog.m618v(MRAIDView.TAG, "onPageFinished: " + url);
            ...
            if (MRAIDView.this.isExpandingPart2) {
                ...
                MRAIDView.this.handler.post(new C12301());
            }
        }

        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            MRAIDLog.m618v(MRAIDView.TAG, "onReceivedError: " + description);
            super.onReceivedError(view, errorCode, description, failingUrl);
        }

        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            MRAIDLog.m618v(MRAIDView.TAG, "shouldOverrideUrlLoading: " + url);
    ...
    protected MRAIDView(Context context, String baseUrl, String data, int backgroundColor, String[] supportedNativeFeatures, MRAIDViewListener listener, MRAIDNativeFeatureListener nativeFeatureListener, boolean isInterstitial) {
        ...
        this.gestureDetector = new GestureDetector(getContext(), new C12201());
        ...
        this.webView.loadDataWithBaseURL(baseUrl, this.htmlData, Mime.HTML_TEXT, C0277C.UTF8_NAME, null);
    }
    ...
    private WebView createWebView() {
        WebView wv = new C12212(this.context);
        ...
        wv.setOnTouchListener(new C12223());
    ...
    private void parseCommandUrl(String commandUrl) {
        MRAIDLog.m618v(TAG, "parseCommandUrl " + commandUrl);
    ...
    private void close(boolean sendCallback) {
        MRAIDLog.m618v("MRAIDView-JS callback", "close " + this.state);
        this.handler.post(new C12234(sendCallback));
    }
    ...
    private void rewardComplete() {
        MRAIDLog.m618v("MRAIDView-JS callback", "rewardComplete " + this.state);
        this.handler.post(new C12245());
    }

    private void createCalendarEvent(String eventJSON) {
        MRAIDLog.m618v("MRAIDView-JS callback", "createCalendarEvent " + eventJSON);
    ...
    private void expand(String url) {
        MRAIDLog.m618v("MRAIDView-JS callback", "expand " + (url != null ? url : "(1-part)"));
        ...
        try {
            url = URLDecoder.decode(url, C0277C.UTF8_NAME);
            if (!(url.startsWith("http://") || url.startsWith("https://"))) {
                url = this.baseUrl + url;
            }
            new Thread(new C12266(url), "2-part-content").start();
    ...
    private void open(String url) {
        try {
            url = URLDecoder.decode(url, C0277C.UTF8_NAME);
            MRAIDLog.m618v("MRAIDView-JS callback", "open " + url);
            if (this.nativeFeatureListener == null) {
                return;
            }
    ...
    private void playVideo(String url) {
        try {
            url = URLDecoder.decode(url, C0277C.UTF8_NAME);
            MRAIDLog.m618v("MRAIDView-JS callback", "playVideo " + url);
            if (this.nativeFeatureListener != null) {
    ...
    private void resize() {
        MRAIDLog.m618v("MRAIDView-JS callback", "resize");
    ...
    private void setOrientationProperties(Map<String, String> properties) {
        ...
        MRAIDLog.m618v("MRAIDView-JS callback", "setOrientationProperties " + allowOrientationChange + " " + forceOrientation);
    ...
    private void setResizeProperties(Map<String, String> properties) {
        ...
        MRAIDLog.m618v("MRAIDView-JS callback", "setResizeProperties " + width + " " + height + " " + offsetX + " " + offsetY + " " + customClosePosition + " " + allowOffscreen);
    ...
    private void storePicture(String url) {
        try {
            url = URLDecoder.decode(url, C0277C.UTF8_NAME);
            MRAIDLog.m618v("MRAIDView-JS callback", "storePicture " + url);
            if (this.nativeFeatureListener != null) {
    ...
    private void useCustomClose(String useCustomCloseString) {
        MRAIDLog.m618v("MRAIDView-JS callback", "useCustomClose " + useCustomCloseString);
    ...
    private String getStringFromUrl(String url) {
        ...
        try {
            ...
            MRAIDLog.m618v(TAG, "response code " + responseCode);
            if (responseCode == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                MRAIDLog.m618v(TAG, "getContentLength " + conn.getContentLength());
                is = conn.getInputStream();
                byte[] buf = new byte[ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED];
                ...
                content = sb.toString();
                MRAIDLog.m618v(TAG, "getStringFromUrl ok, length=" + content.length());
            }
            conn.disconnect();
            if (is == null) {
                return content;
            ...
            MRAIDLog.m616i(TAG, "getStringFromUrl failed " + e2.getLocalizedMessage());
            if (is == null) {
                return null;
            }
            try {
    ...
    private String getStringFromFileUrl(String fileURL) {
        ...
        if (urlElements[STATE_RESIZED].equals("android_asset")) {
            try {
                ...
                MRAIDLog.m615i("Error fetching file: " + e.getMessage());
            }
            return mLine.toString();
        }
        MRAIDLog.m615i("Unknown location to fetch file content");
    ...
    private void setResizedViewSize() {
        MRAIDLog.m618v(TAG, "setResizedViewSize");
    ...
    private void setResizedViewPosition() {
        MRAIDLog.m618v(TAG, "setResizedViewPosition");
        if (this.resizedView != null) {
            int widthInDip = this.resizeProperties.width;
            int heightInDip = this.resizeProperties.height;
    ...
    private void closeFromExpanded(boolean sendCallback) {
        ...
        this.handler.post(new C12288(sendCallback));
    }

    private void closeFromResized(boolean sendCallback) {
        this.state = STATE_DEFAULT;
        this.isClosing = true;
        removeResizeView();
        addView(this.webView);
        this.handler.post(new C12299(sendCallback));
    }
    ...
    private void forceFullScreen() {
        MRAIDLog.m618v(TAG, "forceFullScreen");
        ...
        MRAIDLog.m618v(TAG, "isActionBarShowing " + this.isActionBarShowing);
        MRAIDLog.m618v(TAG, "origTitleBarVisibility " + getVisibilityString(this.origTitleBarVisibility));
    ...
    private void addCloseRegion(View view) {
        ...
        if (view == this.expandedView && !this.useCustomClose) {
            Drawable closeButtonNormalDrawable = MRaidDrawables.getDrawableForImage(this.context, "/assets/drawable/close_button_normal.png", "close_button_normal", ViewCompat.MEASURED_STATE_MASK);
            Drawable closeButtonPressedDrawable = MRaidDrawables.getDrawableForImage(this.context, "/assets/drawable/close_button_pressed.png", "close_button_pressed", ViewCompat.MEASURED_STATE_MASK);
    ...
    private void injectMraidJs(WebView wv) {
        MRAIDLog.m618v(TAG, "injectMraidJs ok " + this.mraidJs.length());
    ...
    private void fireReadyEvent() {
        MRAIDLog.m618v(TAG, "fireReadyEvent");
        injectJavaScript("mraid.fireReadyEvent();");
    }

    @SuppressLint({"DefaultLocale"})
    private void fireStateChangeEvent() {
        MRAIDLog.m618v(TAG, "fireStateChangeEvent");
    ...
    private void fireViewableChangeEvent() {
        MRAIDLog.m618v(TAG, "fireViewableChangeEvent");
    ...
    private void setCurrentPosition() {
        ...
        MRAIDLog.m618v(TAG, "setCurrentPosition [" + x + "," + y + "] (" + width + "x" + height + ")");
    ...
    private void pauseWebView(WebView webView) {
        MRAIDLog.m618v(TAG, "pauseWebView " + webView.toString());
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        super.onConfigurationChanged(newConfig);
        MRAIDLog.m618v(TAG, "onConfigurationChanged " + (newConfig.orientation == STATE_DEFAULT ? "portrait" : "landscape"));
        ((Activity) this.context).getWindowManager().getDefaultDisplay().getMetrics(this.displayMetrics);
    }

    protected void onAttachedToWindow() {
        MRAIDLog.m618v(TAG, "onAttachedToWindow");
        super.onAttachedToWindow();
    }

    protected void onDetachedFromWindow() {
        MRAIDLog.m618v(TAG, "onDetachedFromWindow");
        super.onDetachedFromWindow();
    }

    protected void onVisibilityChanged(View changedView, int visibility) {
        super.onVisibilityChanged(changedView, visibility);
        MRAIDLog.m618v(TAG, "onVisibilityChanged " + getVisibilityString(visibility));
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        super.onWindowVisibilityChanged(visibility);
        int actualVisibility = getVisibility();
        MRAIDLog.m618v(TAG, "onWindowVisibilityChanged " + getVisibilityString(visibility) + " (actual " + getVisibilityString(actualVisibility) + ")");
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        super.onLayout(changed, left, top, right, bottom);
        MRAIDLog.m618v(TAG, "onLayout (" + this.state + ") " + changed + " " + left + " " + top + " " + right + " " + bottom);
        if (this.isForcingFullScreen) {
            MRAIDLog.m618v(TAG, "onLayout ignored");
            return;
        }
    ...
    private void onLayoutWebView(WebView wv, boolean changed, int left, int top, int right, int bottom) {
        ...
        MRAIDLog.m618v(TAG, "onLayoutWebView " + (wv == this.webView ? "1 " : "2 ") + isCurrent + " (" + this.state + ") " + changed + " " + left + " " + top + " " + right + " " + bottom);
        if (!isCurrent) {
            MRAIDLog.m618v(TAG, "onLayoutWebView ignored, not current");
        } else if (this.isForcingFullScreen) {
            MRAIDLog.m618v(TAG, "onLayoutWebView ignored, isForcingFullScreen");
            this.isForcingFullScreen = false;
        } else {
            ...
            if (this.isExpandingFromDefault) {
                ...
                if (!this.isExpandingPart2) {
                    MRAIDLog.m618v(TAG, "calling fireStateChangeEvent 1");
                    fireStateChangeEvent();
                }
                if (this.isInterstitial) {
                    fireReadyEvent();
    ...
    private void calculateScreenSize() {
        ...
        MRAIDLog.m618v(TAG, "calculateScreenSize orientation " + (isPortrait ? "portrait" : "landscape"));
        int width = this.displayMetrics.widthPixels;
        int height = this.displayMetrics.heightPixels;
        MRAIDLog.m618v(TAG, "calculateScreenSize screen size " + width + "x" + height);
    ...
    private void calculateMaxSize() {
        ...
        MRAIDLog.m618v(TAG, "calculateMaxSize frame [" + frame.left + "," + frame.top + "][" + frame.right + "," + frame.bottom + "] (" + frame.width() + "x" + frame.height() + ")");
        int statusHeight = frame.top;
        this.contentViewTop = window.findViewById(16908290).getTop();
        int titleHeight = this.contentViewTop - statusHeight;
        MRAIDLog.m618v(TAG, "calculateMaxSize statusHeight " + statusHeight);
        MRAIDLog.m618v(TAG, "calculateMaxSize titleHeight " + titleHeight);
        MRAIDLog.m618v(TAG, "calculateMaxSize contentViewTop " + this.contentViewTop);
        int width = frame.width();
        int height = this.screenSize.height - this.contentViewTop;
        MRAIDLog.m618v(TAG, "calculateMaxSize max size " + width + "x" + height);
    ...
    private void calculatePosition(boolean isCurrentWebView) {
        ...
        MRAIDLog.m618v(TAG, "calculatePosition " + name + " locationOnScreen [" + x + "," + y + "]");
        MRAIDLog.m618v(TAG, "calculatePosition " + name + " contentViewTop " + this.contentViewTop);
        if (y < this.contentViewTop) {
            MRAIDLog.m618v(TAG, "calculatePosition " + name + " y < contentViewTop, returning");
            return;
        }
        y -= this.contentViewTop;
        int width = view.getWidth();
        int height = view.getHeight();
        MRAIDLog.m618v(TAG, "calculatePosition " + name + " position [" + x + "," + y + "] (" + width + "x" + height + ")");
    ...
    private void applyOrientationProperties() {
        ...
        MRAIDLog.m618v(TAG, "applyOrientationProperties " + this.orientationProperties.allowOrientationChange + " " + this.orientationProperties.forceOrientationString());
        Activity activity = this.context;
        if (getResources().getConfiguration().orientation == STATE_DEFAULT) {
        ...
        MRAIDLog.m618v(TAG, "currentOrientation " + (isCurrentPortrait ? "portrait" : "landscape"));
        switch (this.rotateMode) {
            case STATE_LOADING /*0*/:
            case STATE_DEFAULT /*1*/:
                if (this.orientationProperties.forceOrientation == 0) {
                    activity.setRequestedOrientation(STATE_DEFAULT);
                } else if (this.orientationProperties.forceOrientation == STATE_DEFAULT) {
                    activity.setRequestedOrientation(STATE_LOADING);
                } else if (this.orientationProperties.allowOrientationChange) {
                    activity.setRequestedOrientation(STATE_EXPANDED);
                }
            case STATE_EXPANDED /*2*/:
            case STATE_RESIZED /*3*/:
    ...
    private void restoreOriginalOrientation() {
        MRAIDLog.m612d(TAG, "restoreOriginalOrientation");
        Activity activity = this.context;
