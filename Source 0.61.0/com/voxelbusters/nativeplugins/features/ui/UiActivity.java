...
public class UiActivity extends Activity {
    ...
    class C12582 implements OnClickListener {
        ...
        C12582(String[] strArr, int i, String str) {
    ...
    class C12593 implements OnClickListener {
        ...
        C12593(EditText editText, String[] strArr, int i) {
    ...
    class C12604 implements OnClickListener {
        ...
        C12604(String[] strArr, int i, EditText editText, EditText editText2) {
    ...
    protected void onResume() {
        ...
        if (this.paused) {
            finish();
            new Handler().postDelayed(new C12571(), 10);
        }
    }
    ...
    private void showAlertDialog(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new C12582(tempButtonList, eachButtonIndex, tag));
        }
    ...
    private void showSinglePrompt(Bundle bundle) {
        ...
        String[] tempButtonList = buttonsList;
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new C12593(promptField, tempButtonList, eachButtonIndex));
        }
        this.alertDialog.show();
    }
    ...
    private void showLoginPrompt(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, finalButtonList[eachButtonIndex], new C12604(finalButtonList, eachButtonIndex, usernameField, passwordField));
        }
        this.alertDialog.show();
    }
