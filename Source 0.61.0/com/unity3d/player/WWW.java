...
class WWW extends Thread {
    ...
    protected boolean headerCallback(String str, String str2) {
        ...
        stringBuilder.append("\n\r");
        return headerCallback(this.f665b, stringBuilder.toString());
    }
    ...
    protected void progressCallback(int i, int i2, int i3, int i4, long j, long j2) {
        ...
        progressCallback(this.f665b, f2, f, d, i4);
    }

    protected boolean readCallback(byte[] bArr, int i) {
        return readCallback(this.f665b, bArr, i);
    }
    ...
    public void run() {
        try {
            ...
            errorCallback(this.f665b, "Error: " + th.toString());
        }
    }
    ...
    public void runSafe() {
        ...
        this.f664a = i;
        if (i > 5) {
            errorCallback(this.f665b, "Too many redirects");
            return;
        }
        try {
            URL url = new URL(this.f666c);
            URLConnection openConnection = url.openConnection();
            if (openConnection instanceof HttpsURLConnection) {
                SSLSocketFactory a = C1044a.m546a();
                if (a != null) {
            ...
            if (!url.getProtocol().equalsIgnoreCase(Scheme.FILE) || url.getHost() == null || url.getHost().length() == 0) {
                ...
                if (this.f668e != null) {
                    for (Entry entry : this.f668e.entrySet()) {
                ...
                if (this.f667d != null) {
                    ...
                    try {
                        ...
                        int i2 = 0;
                        while (i2 < this.f667d.length) {
                            min = Math.min(1428, this.f667d.length - i2);
                            outputStream.write(this.f667d, i2, min);
                            i2 += min;
                            progressCallback(i2, this.f667d.length, 0, 0, 0, 0);
                        }
                    } catch (Exception e) {
                        errorCallback(this.f665b, e.toString());
                        return;
                    }
                }
                    ...
                    try {
                        ...
                        if (headerFields != null && (min == VASTPlayer.ERROR_WRAPPER_TIMEOUT || min == VASTPlayer.ERROR_EXCEEDED_WRAPPER_LIMIT)) {
                            ...
                            if (!(list == null || list.isEmpty())) {
                                ...
                                this.f666c = (String) list.get(0);
                                run();
                                return;
                            }
                        }
                    } catch (IOException e2) {
                        errorCallback(this.f665b, e2.toString());
                        return;
                    }
                }
                ...
                if (headerCallback) {
                    errorCallback(this.f665b, this.f666c + " aborted");
                    return;
                }
                ...
                try {
                    ...
                    if (obj != null) {
                        errorCallback(this.f665b, str);
                    }
                    progressCallback(0, 0, i3, i3, 0, 0);
                    doneCallback(this.f665b);
                    return;
                } catch (Exception e3) {
                    errorCallback(this.f665b, e3.toString());
                    return;
                }
            }
            errorCallback(this.f665b, url.getHost() + url.getFile() + " is not an absolute path!");
        } catch (MalformedURLException e4) {
            errorCallback(this.f665b, e4.toString());
        } catch (IOException e22) {
            errorCallback(this.f665b, e22.toString());
        }
    }
}
