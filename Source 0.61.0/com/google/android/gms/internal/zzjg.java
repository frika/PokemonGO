...
public class zzjg extends zzja {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, String url) {
        ...
        try {
            ...
            if (webView instanceof zziz) {
                ...
                String str = com_google_android_gms_internal_zziz.zzaN().zztf ? (String) zzby.zzuP.get() : com_google_android_gms_internal_zziz.zzhi() ? (String) zzby.zzuO.get() : (String) zzby.zzuN.get();
                zzb.m484v("shouldInterceptRequest(" + str + ")");
                return zzd(com_google_android_gms_internal_zziz.getContext(), this.zzoM.zzhh().zzJu, str);
            }
    ...
    protected WebResourceResponse zzd(Context context, String str, String str2) throws IOException, ExecutionException, InterruptedException, TimeoutException {
        ...
        return str3 == null ? null : new WebResourceResponse("application/javascript", C0277C.UTF8_NAME, new ByteArrayInputStream(str3.getBytes(C0277C.UTF8_NAME)));
    }
}
