...
public class zzfb extends zzfh {
    ...
    class C06981 implements OnClickListener {
        ...
        C06981(zzfb com_google_android_gms_internal_zzfb) {
    ...
    class C06992 implements OnClickListener {
        ...
        C06992(zzfb com_google_android_gms_internal_zzfb) {
            this.zzAa = com_google_android_gms_internal_zzfb;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(C0328R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(C0328R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(C0328R.string.accept, "Accept"), new C06981(this));
            zzK.setNegativeButton(zzp.zzby().zzd(C0328R.string.decline, "Decline"), new C06992(this));
            zzK.create().show();
        } else {
