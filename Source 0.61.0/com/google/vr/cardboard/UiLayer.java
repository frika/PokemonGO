...
public class UiLayer {
    ...
    class C09094 implements Runnable {
    ...
    class C09105 implements Runnable {
        final /* synthetic */ boolean val$enabled;
    ...
    class C09127 implements Runnable {
        final /* synthetic */ boolean val$enabled;
    ...
    public void attachUiLayer(ViewGroup parentView) {
        ((Activity) this.context).runOnUiThread(new C09083(parentView));
    }

    public void setEnabled(boolean enabled) {
        ((Activity) this.context).runOnUiThread(new C09094(enabled));
    }

    public void setSettingsButtonEnabled(boolean enabled) {
        this.isSettingsButtonEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new C09105(enabled));
    }

    public void setBackButtonListener(Runnable runnable) {
        this.backButtonRunnable = runnable;
        ((Activity) this.context).runOnUiThread(new C09116(runnable));
    }

    public void setAlignmentMarkerEnabled(boolean enabled) {
        this.isAlignmentMarkerEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new C09127(enabled));
    }
