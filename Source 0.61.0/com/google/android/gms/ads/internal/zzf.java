...
public class zzf extends zzc {
    ...
    class C03641 implements zzb {
        final /* synthetic */ zzhs zzoO;
        final /* synthetic */ zzf zzoP;

        C03641(zzf com_google_android_gms_ads_internal_zzf, zzhs com_google_android_gms_internal_zzhs) {
            ...
            if (this.zzot.zzbN()) {
                if (com_google_android_gms_internal_zzhs2.zzBD != null) {
                    ...
                    if (com_google_android_gms_internal_zzhs2.zzbY()) {
                        ...
                        com_google_android_gms_internal_zzhs2.zzBD.zzhe().zza(new C03641(this, com_google_android_gms_internal_zzhs2));
                    }
                }
