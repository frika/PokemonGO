...
public class Offer {
    ...
    public static Offer createFromValues(HashMap<String, String> values) {
        ...
        return new Offer(map.getInt("offer_id"), map.get("bundle_id"), contentId, map.getInt("virtualgoodID"), map.getInt("currencyID"), map.getInt(TriggerIfContentAvailable.ID), map.get("zone_id"), map.getInt("t"), map.get("item"), map.getInt("itemQty", 0), map.getFloat("price", 0.0f), map.get("currency"), OfferType.getType(map.getInt(Keys.TYPE)), map.get("script"), map.getDate("start_date"), map.getDate("end_date"), map.get(TtmlNode.TAG_METADATA));
    }
    ...
    public int hashCode() {
        ...
        hashCode2 = (((hashCode2 + hashCode) * 31) + this.f732t) * 31;
    ...
    public String toString() {
        return "Offer{id=" + this.id + ", itemId='" + this.itemId + '\'' + ", contentId=" + this.contentId + ", vg_virtualGoodID=" + this.vg_virtualGoodID + ", vg_currencyID=" + this.vg_currencyID + ", adZoneID=" + this.adZoneID + ", zoneName='" + this.zoneName + '\'' + ", t=" + this.f732t + ", itemName='" + this.itemName + '\'' + ", itemQuantity=" + this.itemQuantity + ", purchasePrice=" + this.purchasePrice + ", purchaseCurrency='" + this.purchaseCurrency + '\'' + ", type=" + this.type + ", offerHtml='" + this.offerHtml + '\'' + ", startTime=" + this.startTime + ", endTime=" + this.endTime + ", metadata='" + this.metadata + '\'' + ", consumed=" + this.consumed + '}';
    }
}
