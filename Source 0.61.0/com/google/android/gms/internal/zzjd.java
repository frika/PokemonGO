...
class zzjd extends WebView implements OnGlobalLayoutListener, DownloadListener, zziz {
    ...
    class C07531 implements Runnable {
        ...
        C07531(zzjd com_google_android_gms_internal_zzjd) {
    ...
    public void destroy() {
        synchronized (this.zzpd) {
            ...
            zzhC();
            this.zzKq = true;
            zzb.m484v("Initiating WebView self destruct sequence in 3...");
            this.zzKn.zzhs();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzb.m484v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhj() {
        synchronized (this.zzpd) {
            zzb.m484v("Destroying WebView!");
            zzid.zzIE.post(new C07531(this));
        }
    }
