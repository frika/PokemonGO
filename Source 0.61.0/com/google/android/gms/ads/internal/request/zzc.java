...
public final class zzc {
    ...
    static class C03531 implements zzb {
        final /* synthetic */ Context zzry;

        C03531(Context context) {
            this.zzry = context;
        }
    ...
    public static zzhz zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zza com_google_android_gms_ads_internal_request_zzc_zza) {
        return zza(context, adRequestInfoParcel, com_google_android_gms_ads_internal_request_zzc_zza, new C03531(context));
    }
