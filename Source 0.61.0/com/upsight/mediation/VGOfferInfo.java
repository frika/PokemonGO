...
public class VGOfferInfo {
    ...
    public String toJSONString() {
        ...
        try {
            ...
            return key.value(j).key(TtmlNode.TAG_METADATA).value(this.metadata == null ? BuildConfig.FLAVOR : Base64.encodeToString(this.metadata.getBytes(), 2)).endObject().endObject().toString();
