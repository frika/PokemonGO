...
public class NianticLocationManager extends ContextService {
    ...
    class C09591 implements GpsProviderListener {
    ...
    class C09602 implements ProviderListener {
        final /* synthetic */ String val$name;
    ...
    class C09613 implements Runnable {
    ...
    private void addProvider(String name, Provider provider) {
        ...
        if (provider instanceof GpsProvider) {
            provider.setListener(new C09591(name));
        } else {
            provider.setListener(new C09602(name));
        }
    }
    ...
    public void configureLocationParameters(double update_distance, int gps_update_time_ms, int net_update_time_ms) {
        ContextService.runOnServiceHandler(new C09613(gps_update_time_ms, update_distance, net_update_time_ms));
    }
