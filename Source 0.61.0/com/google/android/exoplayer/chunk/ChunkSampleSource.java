...
public class ChunkSampleSource implements SampleSource, SampleSourceReader, Callback {
    ...
    class C02951 implements Runnable {
        ...
        C02951(long j, int i, int i2, Format format, long j2, long j3) {
            this.val$length = j;
            this.val$type = i;
            this.val$trigger = i2;
    ...
    class C02962 implements Runnable {
        ...
        C02962(long j, int i, int i2, Format format, long j2, long j3, long j4, long j5) {
    ...
    class C02984 implements Runnable {
        ...
        C02984(IOException iOException) {
    ...
    class C02995 implements Runnable {
        final /* synthetic */ long val$mediaEndTimeUs;
        final /* synthetic */ long val$mediaStartTimeUs;

        C02995(long j, long j2) {
    ...
    class C03006 implements Runnable {
        ...
        C03006(Format format, int i, long j) {
            this.val$format = format;
            this.val$trigger = i;
    ...
    public int readData(int track, long positionUs, MediaFormatHolder formatHolder, SampleHolder sampleHolder) {
        ...
        if (haveSamples) {
            ...
            sampleHolder.flags = (decodeOnly ? C0277C.SAMPLE_FLAG_DECODE_ONLY : STATE_IDLE) | sampleHolder.flags;
    ...
    private void notifyLoadStarted(long length, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02951(length, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs));
        }
    }
    ...
    private void notifyLoadCompleted(long bytesLoaded, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02962(bytesLoaded, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs, elapsedRealtimeMs, loadDurationMs));
        }
    }

    private void notifyLoadCanceled(long bytesLoaded) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02973(bytesLoaded));
        }
    }

    private void notifyLoadError(IOException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02984(e));
        }
    }

    private void notifyUpstreamDiscarded(long mediaStartTimeUs, long mediaEndTimeUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02995(mediaStartTimeUs, mediaEndTimeUs));
        }
    }

    private void notifyDownstreamFormatChanged(Format format, int trigger, long positionUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03006(format, trigger, positionUs));
        }
    }
}
