...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C14221 implements Action0 {
            C14221() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C14221(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C14231(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this) {
                ...
                this.inner.schedule(new C14242(chunk), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
            }
        }
