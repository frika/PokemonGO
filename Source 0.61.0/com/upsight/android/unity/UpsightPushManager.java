...
public class UpsightPushManager implements IUpsightExtensionManager {
    ...
    class C12071 implements Runnable {
        ...
        class C12061 implements OnUnregisterListener {
            C12061() {
            }
        ...
        public void run() {
            ...
            UpsightGooglePushServices.unregister(UpsightPushManager.this.mUpsight, new C12061());
        }
    }
    ...
    class C12092 implements Runnable {
        ...
        class C12081 implements OnRegisterListener {
            C12081() {
            }
        ...
        public void run() {
            ...
            UpsightGooglePushServices.register(UpsightPushManager.this.mUpsight, new C12081());
        }
    }
    ...
    public void unregisterForPushNotifications() {
        if (this.mUpsight != null) {
            UnityBridge.runSafelyOnUiThread(new C12071());
        }
    }

    public void registerForPushNotifications() {
        if (this.mUpsight != null) {
            UnityBridge.runSafelyOnUiThread(new C12092());
        }
    }
