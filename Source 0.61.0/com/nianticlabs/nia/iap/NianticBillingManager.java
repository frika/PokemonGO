...
public class NianticBillingManager extends ContextService implements Delegate {
    ...
    class C09503 implements Runnable {
        final /* synthetic */ String val$item;
        final /* synthetic */ String val$userIdToken;

        C09503(String str, String str2) {
            this.val$item = str;
    ...
    class C09514 implements Runnable {
        final /* synthetic */ boolean val$success;
        final /* synthetic */ String val$transactionToken;

        C09514(boolean z, String str) {
            this.val$success = z;
    ...
    class C09525 implements Runnable {
    ...
    public void initialize() {
        ...
        ContextService.runOnServiceHandler(new C09481());
    }
    ...
    public void getPurchasableItems(String[] purchasableItems) {
        ContextService.runOnServiceHandler(new C09492(new ArrayList(Arrays.asList(purchasableItems))));
    }

    public void purchaseVendorItem(String item, String userIdToken) {
        ContextService.runOnServiceHandler(new C09503(item, userIdToken));
    }

    public void redeemReceiptResult(boolean success, String transactionToken) {
        ContextService.runOnServiceHandler(new C09514(success, transactionToken));
    }

    public void onConnectionStateChanged(boolean connected) {
        ContextService.runOnServiceHandler(new C09525(connected));
    }
