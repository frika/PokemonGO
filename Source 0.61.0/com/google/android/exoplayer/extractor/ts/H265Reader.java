...
final class H265Reader extends ElementaryStreamReader {
        ...
        public void readNalUnitData(byte[] data, int offset, int limit) {
            if (this.lookingForFirstSliceFlag) {
                ...
                if (headerOffset < limit) {
                    boolean z;
                    if ((data[headerOffset] & AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) != 0) {
                        z = true;
                    } else {
                        z = false;
                    }
    ...
    public H265Reader(TrackOutput output, SeiReader seiReader) {
        ...
        this.vps = new NalUnitTargetBuffer(VPS_NUT, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        this.sps = new NalUnitTargetBuffer(SPS_NUT, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        this.pps = new NalUnitTargetBuffer(PPS_NUT, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        this.prefixSei = new NalUnitTargetBuffer(PREFIX_SEI_NUT, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        this.suffixSei = new NalUnitTargetBuffer(SUFFIX_SEI_NUT, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
