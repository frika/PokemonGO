...
public final class SlidingPercentile {
    ...
    static class C03241 implements Comparator<Sample> {
        C03241() {
        }
    ...
    static class C03252 implements Comparator<Sample> {
        C03252() {
        }
    ...
    static {
        INDEX_COMPARATOR = new C03241();
        VALUE_COMPARATOR = new C03252();
    }
