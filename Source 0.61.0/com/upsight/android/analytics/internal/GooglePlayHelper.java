...
class GooglePlayHelper extends UpsightGooglePlayHelper {
    ...
    public void trackPurchase(int quantity, String currency, double price, double totalPrice, String product, Intent responseData, UpsightPublisherData publisherData) throws UpsightException {
        int responseCode = responseData.getIntExtra(UpsightGooglePlayHelper.PURCHASE_RESPONSE_CODE, Cue.TYPE_UNSET);
        String msg;
        switch (responseCode) {
            case C1628R.styleable.RecyclerView_android_orientation /*0*/:
                ...
                if (TextUtils.isEmpty(purchaseData)) {
                    ...
                    this.mUpsight.getLogger().m576e(Upsight.LOG_TAG, msg, new Object[0]);
                    ...
                    try {
                        ...
                        if (purchase != null) {
                            ...
                            try {
                                ...
                                this.mUpsight.getLogger().m577e(Upsight.LOG_TAG, e, msg, new Object[0]);
                        ...
                        this.mUpsight.getLogger().m577e(Upsight.LOG_TAG, e2, msg, new Object[0]);
