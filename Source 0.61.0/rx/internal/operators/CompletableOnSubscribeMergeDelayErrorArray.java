...
public final class CompletableOnSubscribeMergeDelayErrorArray implements CompletableOnSubscribe {
    ...
    class C13831 implements CompletableSubscriber {
        ...
        C13831(CompositeSubscription compositeSubscription, Queue queue, AtomicInteger atomicInteger, CompletableSubscriber completableSubscriber) {
        ...
        while (i$ < len$) {
            ...
            if (!set.isUnsubscribed()) {
                if (c == null) {
                    ...
                    c.subscribe(new C13831(set, q, wip, s));
                }
                i$++;
            } else {
                return;
