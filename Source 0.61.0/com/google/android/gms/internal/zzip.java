...
public class zzip {
    ...
    static class C07501 implements Runnable {
        final /* synthetic */ zzin zzJB;
        final /* synthetic */ zza zzJC;
        final /* synthetic */ zziq zzJD;

        C07501(zzin com_google_android_gms_internal_zzin, zza com_google_android_gms_internal_zzip_zza, zziq com_google_android_gms_internal_zziq) {
        ...
        public void run() {
            /*
            r3 = this;
            r0 = r3.zzJB;	 Catch:{ CancellationException -> 0x001c, InterruptedException -> 0x001a, ExecutionException -> 0x0012 }
            r1 = r3.zzJC;	 Catch:{ CancellationException -> 0x001c, InterruptedException -> 0x001a, ExecutionException -> 0x0012 }
            r2 = r3.zzJD;	 Catch:{ CancellationException -> 0x001c, InterruptedException -> 0x001a, ExecutionException -> 0x0012 }
    ...
    static class C07512 implements Runnable {
        final /* synthetic */ AtomicInteger zzJE;
        final /* synthetic */ int zzJF;
        final /* synthetic */ zzin zzJG;
        final /* synthetic */ List zzJH;

        C07512(AtomicInteger atomicInteger, int i, zzin com_google_android_gms_internal_zzin, List list) {
        ...
        L_0x000a:
            r0 = r2.zzJG;	 Catch:{ ExecutionException -> 0x001d, InterruptedException -> 0x0016 }
            r1 = r2.zzJH;	 Catch:{ ExecutionException -> 0x001d, InterruptedException -> 0x0016 }
            r1 = com.google.android.gms.internal.zzip.zzi(r1);	 Catch:{ ExecutionException -> 0x001d, InterruptedException -> 0x0016 }
    ...
    public static <A, B> zziq<B> zza(zziq<A> com_google_android_gms_internal_zziq_A, zza<A, B> com_google_android_gms_internal_zzip_zza_A__B) {
        ...
        com_google_android_gms_internal_zziq_A.zzc(new C07501(com_google_android_gms_internal_zzin, com_google_android_gms_internal_zzip_zza_A__B, com_google_android_gms_internal_zziq_A));
    ...
    public static <V> zziq<List<V>> zzh(List<zziq<V>> list) {
        ...
        for (zziq zzc : list) {
            zzc.zzc(new C07512(atomicInteger, size, com_google_android_gms_internal_zzin, list));
        }
        return com_google_android_gms_internal_zzin;
    }
