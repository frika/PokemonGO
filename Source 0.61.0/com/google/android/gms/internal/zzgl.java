...
public class zzgl extends zzhz {
    ...
    class C07091 implements Runnable {
        ...
        C07091(zzgl com_google_android_gms_internal_zzgl, zzhs com_google_android_gms_internal_zzhs) {
    ...
    public void zzbn() {
        ...
        try {
            ...
            com_google_android_gms_internal_zzhs = (zzhs) this.zzDC.get(HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS, TimeUnit.MILLISECONDS);
            i = -2;
        ...
        zzid.zzIE.post(new C07091(this, com_google_android_gms_internal_zzhs));
    }
}
