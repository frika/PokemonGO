...
public abstract class UpsightOptOutStatus {
    ...
    public static void set(UpsightSessionContext upsight, boolean optOut) {
        set(upsight.getUpsightContext(), optOut);
    }

    public static boolean get(UpsightSessionContext upsight) {
        return get(upsight.getUpsightContext());
    }
}
