...
public class zzbk extends Thread {
    ...
    class C06391 implements Runnable {
        ...
        C06391(zzbk com_google_android_gms_internal_zzbk, View view) {
    ...
    class C06412 implements Runnable {
        ...
        class C06401 implements ValueCallback<String> {
            final /* synthetic */ C06412 zzsl;

            C06401(C06412 c06412) {
                this.zzsl = c06412;
            }
        ...
        C06412(zzbk com_google_android_gms_internal_zzbk, zzbh com_google_android_gms_internal_zzbh, WebView webView) {
            this.zzsh = com_google_android_gms_internal_zzbk;
            this.zzsj = com_google_android_gms_internal_zzbh;
            this.zzsk = webView;
            this.zzsi = new C06401(this);
        }
    ...
    void zza(zzbh com_google_android_gms_internal_zzbh, WebView webView, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString(PendingDialog.TEXT);
    ...
    boolean zza(WebView webView, zzbh com_google_android_gms_internal_zzbh) {
        ...
        com_google_android_gms_internal_zzbh.zzcp();
        webView.post(new C06412(this, com_google_android_gms_internal_zzbh, webView));
        return true;
    }
    ...
    boolean zzf(View view) {
        ...
        view.post(new C06391(this, view));
        return true;
    }
