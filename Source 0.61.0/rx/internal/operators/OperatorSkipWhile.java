...
public final class OperatorSkipWhile<T> implements Operator<T, T> {
    ...
    class C14971 extends Subscriber<T> {
        int index;
        boolean skipping;
        final /* synthetic */ Subscriber val$child;

        C14971(Subscriber x0, Subscriber subscriber) {
    ...
    static class C14982 implements Func2<T, Integer, Boolean> {
