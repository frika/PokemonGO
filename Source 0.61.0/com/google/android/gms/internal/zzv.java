...
public class zzv implements zzb {
    ...
    public zzv(File file, int i) {
        this.zzax = new LinkedHashMap(16, PlayerControls.DOWN_STATE, true);
        this.zzay = 0;
        this.zzaz = file;
        this.zzaA = i;
    }
    ...
    static void zza(OutputStream outputStream, String str) throws IOException {
        byte[] bytes = str.getBytes(C0277C.UTF8_NAME);
    ...
    static String zzd(InputStream inputStream) throws IOException {
        return new String(zza(inputStream, (int) zzc(inputStream)), C0277C.UTF8_NAME);
    }
