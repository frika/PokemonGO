...
public final class OperatorDelayWithSelector<T, V> implements Operator<T, T> {
    ...
    class C14351 extends Subscriber<T> {
        ...
        class C14341 implements Func1<V, T> {
        ...
        C14351(Subscriber x0, PublishSubject publishSubject, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            try {
                this.val$delayedEmissions.onNext(((Observable) OperatorDelayWithSelector.this.itemDelay.call(t)).take(1).defaultIfEmpty(null).map(new C14341(t)));
            } catch (Throwable e) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> _child) {
        ...
        return new C14351(_child, delayedEmissions, child);
    }
}
