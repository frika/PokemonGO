...
public final class OnSubscribeAmb<T> implements OnSubscribe<T> {
    ...
    class C13911 implements Action0 {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C13911(AtomicReference atomicReference, Selection selection) {
    ...
    class C13922 implements Producer {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C13922(AtomicReference atomicReference, Selection selection) {
            this.val$choice = atomicReference;
            this.val$selection = selection;
        }
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        subscriber.add(Subscriptions.create(new C13911(choice, selection)));
        ...
        subscriber.setProducer(new C13922(choice, selection));
    }
