...
public class ByteOrderMark implements Serializable {
    ...
    static {
        UTF_8 = new ByteOrderMark(C0277C.UTF8_NAME, 239, 187, 191);
        UTF_16BE = new ByteOrderMark("UTF-16BE", 254, NalUnitUtil.EXTENDED_SAR);
        UTF_16LE = new ByteOrderMark("UTF-16LE", NalUnitUtil.EXTENDED_SAR, 254);
        UTF_32BE = new ByteOrderMark("UTF-32BE", 0, 0, 254, NalUnitUtil.EXTENDED_SAR);
        UTF_32LE = new ByteOrderMark("UTF-32LE", NalUnitUtil.EXTENDED_SAR, 254, 0, 0);
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.bytes.length; i++) {
            ...
            builder.append("0x");
            builder.append(Integer.toHexString(this.bytes[i] & NalUnitUtil.EXTENDED_SAR).toUpperCase());
        }
        builder.append(']');
