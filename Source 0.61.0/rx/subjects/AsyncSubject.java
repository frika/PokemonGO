...
public final class AsyncSubject<T> extends Subject<T, T> {
    ...
    static class C16131 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ SubjectSubscriptionManager val$state;

        C16131(SubjectSubscriptionManager subjectSubscriptionManager) {
    ...
    public static <T> AsyncSubject<T> create() {
        ...
        state.onTerminated = new C16131(state);
