...
public class zzfc extends zzfh {
    ...
    class C07001 implements OnClickListener {
        ...
        C07001(zzfc com_google_android_gms_internal_zzfc) {
    ...
    static {
        zzAb = new HashSet(Arrays.asList(new String[]{"top-left", "top-right", "top-center", TtmlNode.CENTER, "bottom-left", "bottom-right", "bottom-center"}));
    }
            ...
            if (this.zzAd) {
                ...
                switch (z) {
                    ...
                    case MRAIDResizeProperties.CUSTOM_CLOSE_POSITION_BOTTOM_CENTER /*5*/:
                        i3 = ((this.zzAe + this.zzAg) + this.zznQ) - 50;
                        i2 = ((this.zzAf + this.zzAh) + this.zznR) - 50;
                        break;
                    default:
                        i3 = ((this.zzAe + this.zzAg) + this.zznQ) - 50;
