...
public final class PushIntentService extends IntentService {
    ...
    static /* synthetic */ class C11131 {
        static final /* synthetic */ int[] f723x51d6a9c0;

        static {
            f723x51d6a9c0 = new int[UriTypes.values().length];
            try {
                f723x51d6a9c0[UriTypes.CUSTOM.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f723x51d6a9c0[UriTypes.DEFAULT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f723x51d6a9c0[UriTypes.ACTIVITY.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f723x51d6a9c0[UriTypes.PLACEMENT.ordinal()] = 4;
        ...
        if (!TextUtils.isEmpty(stringValue) && TextUtils.isDigitsOnly(stringValue)) {
            try {
                ...
                if (defaultValue == null) {
                    logger.m577e(LOG_TAG, e, String.format("Could not parse %s. Setting to null.", new Object[]{stringValue}), new Object[0]);
                } else {
                    logger.m577e(LOG_TAG, e, String.format("Could not parse %s. Setting to %d.", new Object[]{stringValue, defaultValue}), new Object[0]);
                }
            }
        }
        return integerValue;
    ...
    PushIds parsePushIds(Uri uri, Bundle extras, UpsightLogger logger) {
        return new PushIds(parseAsInt(extras.getString(PushParams.message_id.name()), INVALID_MSG_ID, logger), parseAsInt(extras.getString(PushParams.msg_campaign_id.name()), null, logger), parseAsInt(uri.getQueryParameter(PushParams.content_id.name()), null, logger), null);
    }
    ...
    private void interpretPushEvent(Bundle extras) {
        ...
        if (uri != null) {
            ...
            switch (C11131.f723x51d6a9c0[checkUri(logger, uri).ordinal()]) {
                ...
                case C1628R.styleable.RecyclerView_reverseLayout /*3*/:
                    try {
                        ...
                        logger.m577e(LOG_TAG, e, "Could not parse class name", new Object[0]);
                        break;
                    }
    ...
    public UriTypes checkUri(UpsightLogger logger, Uri uri) {
        ...
        if (TextUtils.isEmpty(host) || TextUtils.isEmpty(scheme)) {
            logger.m576e(LOG_TAG, String.format("Invalid URI, host or scheme is null or empty: %s.", new Object[]{uri}), new Object[0]);
            ...
            try {
                ...
                logger.m576e(LOG_TAG, String.format("Nothing registered for %s", new Object[]{uri}), new Object[0]);
                return UriTypes.INVALID;
            }
        ...
        try {
            ...
            if (bundle != null && bundle.containsKey(NOTIFICATION_BUILDER_FACTORY_KEY_NAME)) {
                try {
                    ...
                    logger.m576e(Upsight.LOG_TAG, String.format("Class %s must implement %s!", new Object[]{clazz.getName(), UpsightPushNotificationBuilderFactory.class.getName()}), new Object[0]);
                } catch (ClassNotFoundException e) {
                    logger.m576e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s was not found.", new Object[]{customBuilderClassName}), e);
                } catch (InstantiationException e2) {
                    logger.m576e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s does not have public access.", new Object[]{customBuilderClassName}), e2);
                } catch (IllegalAccessException e3) {
                    logger.m576e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s could not be instantiated.", new Object[]{customBuilderClassName}), e3);
                }
            }
        } catch (NameNotFoundException e4) {
            logger.m576e(Upsight.LOG_TAG, "Unexpected error: Package name missing!?", e4);
        }
        return new Default();
    }
    ...
    private void showNotification(Intent messageIntent, boolean isDispatchFromForeground, Integer campaignId, Integer messageId, Integer contentId, String title, String text, String imageUrl) {
        PendingIntent notifyIntent = PendingIntent.getService(getApplicationContext(), messageId.intValue(), PushClickIntentService.newIntent(getApplicationContext(), messageIntent, isDispatchFromForeground, campaignId, messageId, contentId), 1342177280);
