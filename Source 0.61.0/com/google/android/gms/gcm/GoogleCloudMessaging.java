...
public class GoogleCloudMessaging {
    ...
    class C06071 extends Handler {
        final /* synthetic */ GoogleCloudMessaging zzaCB;

        C06071(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaCA = new Messenger(new C06071(this, Looper.getMainLooper()));
    }
    ...
    Intent zzy(Bundle bundle) throws IOException {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                return (Intent) this.zzaCz.poll(VASTModel.DOWNLOAD_TIMEOUT_LIMIT, TimeUnit.MILLISECONDS);
