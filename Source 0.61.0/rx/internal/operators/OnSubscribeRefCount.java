...
public final class OnSubscribeRefCount<T> implements OnSubscribe<T> {
    ...
    class C14081 implements Action1<Subscription> {
        final /* synthetic */ Subscriber val$subscriber;
        final /* synthetic */ AtomicBoolean val$writeLocked;

        C14081(Subscriber subscriber, AtomicBoolean atomicBoolean) {
    ...
    class C14092 extends Subscriber<T> {
        final /* synthetic */ CompositeSubscription val$currentBase;
        final /* synthetic */ Subscriber val$subscriber;

        C14092(Subscriber x0, Subscriber subscriber, CompositeSubscription compositeSubscription) {
            this.val$subscriber = subscriber;
    ...
    class C14103 implements Action0 {
        final /* synthetic */ CompositeSubscription val$current;

        C14103(CompositeSubscription compositeSubscription) {
