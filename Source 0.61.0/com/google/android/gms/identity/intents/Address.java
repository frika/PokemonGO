...
public final class Address {
    ...
    static class C06141 extends com.google.android.gms.common.api.Api.zza<zzoy, AddressOptions> {
        C06141() {
        }
    ...
    static class C06152 extends zza {
        final /* synthetic */ UserAddressRequest zzaDf;
        final /* synthetic */ int zzaDg;

        C06152(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
    ...
    public static void requestUserAddress(GoogleApiClient googleApiClient, UserAddressRequest request, int requestCode) {
        googleApiClient.zza(new C06152(googleApiClient, request, requestCode));
    }
}
