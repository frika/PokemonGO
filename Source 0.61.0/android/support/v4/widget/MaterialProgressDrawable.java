...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01021 extends Animation {
    ...
    class C01032 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C01043 implements Callback {
        C01043() {
        }
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            if (this.mAlpha < NalUnitUtil.EXTENDED_SAR) {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.lineTo((((float) this.mArrowWidth) * this.mArrowScale) / Default.HTTP_REQUEST_BACKOFF_MULT, ((float) this.mArrowHeight) * this.mArrowScale);
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= 0.0d || minEdge < 0.0f) {
                insets = (float) Math.ceil((double) (this.mStrokeWidth / Default.HTTP_REQUEST_BACKOFF_MULT));
            } else {
                insets = (float) (((double) (minEdge / Default.HTTP_REQUEST_BACKOFF_MULT)) - this.mRingCenterRadius);
            }
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & NalUnitUtil.EXTENDED_SAR;
        int startR = (startInt >> 16) & NalUnitUtil.EXTENDED_SAR;
        int startG = (startInt >> 8) & NalUnitUtil.EXTENDED_SAR;
        int startB = startInt & NalUnitUtil.EXTENDED_SAR;
        int endInt = Integer.valueOf(endValue).intValue();
        return ((((((int) (((float) (((endInt >> 24) & NalUnitUtil.EXTENDED_SAR) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & NalUnitUtil.EXTENDED_SAR) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & NalUnitUtil.EXTENDED_SAR) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & NalUnitUtil.EXTENDED_SAR) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C01021(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C01032(ring));
