...
public class zzgd implements Runnable {
    ...
    public void zza(AdResponseParcel adResponseParcel, zzji com_google_android_gms_internal_zzji) {
        ...
        this.zzoM.loadDataWithBaseURL(TextUtils.isEmpty(adResponseParcel.zzBF) ? null : zzp.zzbv().zzaz(adResponseParcel.zzBF), adResponseParcel.body, Mime.HTML_TEXT, C0277C.UTF8_NAME, null);
    }
