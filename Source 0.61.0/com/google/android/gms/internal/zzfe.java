...
public class zzfe extends zzfh {
    ...
    class C07011 implements OnClickListener {
        ...
        C07011(zzfe com_google_android_gms_internal_zzfe, String str, String str2) {
    ...
    class C07022 implements OnClickListener {
        ...
        C07022(zzfe com_google_android_gms_internal_zzfe) {
            this.zzAu = com_google_android_gms_internal_zzfe;
        }
    ...
    public zzfe(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
        super(com_google_android_gms_internal_zziz, MRAIDNativeFeature.STORE_PICTURE);
        this.zzvS = map;
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzp.zzbv().zzaB(zzaj)) {
                    ...
                    zzK.setTitle(zzp.zzby().zzd(C0328R.string.store_picture_title, "Save image"));
                    zzK.setMessage(zzp.zzby().zzd(C0328R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzK.setPositiveButton(zzp.zzby().zzd(C0328R.string.accept, "Accept"), new C07011(this, str, zzaj));
                    zzK.setNegativeButton(zzp.zzby().zzd(C0328R.string.decline, "Decline"), new C07022(this));
                    zzK.create().show();
                    return;
                }
