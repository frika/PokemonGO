...
public final class OperatorSkipTimed<T> implements Operator<T, T> {
    ...
    class C14931 implements Action0 {
        final /* synthetic */ AtomicBoolean val$gate;

        C14931(AtomicBoolean atomicBoolean) {
    ...
    class C14942 extends Subscriber<T> {
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ AtomicBoolean val$gate;

        C14942(Subscriber x0, AtomicBoolean atomicBoolean, Subscriber subscriber) {
            this.val$gate = atomicBoolean;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        worker.schedule(new C14931(gate), this.time, this.unit);
        return new C14942(child, gate, child);
    }
}
