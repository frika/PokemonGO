...
public class ConsolePlugin implements Destroyable, Listener, WarningView.Listener {
    ...
    static class C16311 implements OnDispatchListener {
        C16311() {
        }
        ...
        public void onDispatchEntries(List<ConsoleEntry> entries) {
            if (ConsolePlugin.instance != null) {
                ...
                Log.m627e("Can't log message: plugin instance is not initialized", new Object[0]);
            }
        }
    }

    /* renamed from: spacemadness.com.lunarconsole.console.ConsolePlugin.2 */
    static class C16322 implements Runnable {
        ...
        C16322(Activity activity, String str, int i, int i2, ConsolePluginImp consolePluginImp) {
    ...
    static class C16333 implements Runnable {
        C16333() {
        }
    ...
    static class C16344 implements Runnable {
        C16344() {
        }
    ...
    static class C16355 implements Runnable {
        C16355() {
        }
    ...
    static class C16366 implements Runnable {
        C16366() {
        }
    ...
    class C16377 implements OnGestureListener {
        C16377() {
        }
    ...
    class C16388 implements AnimationListener {
        C16388() {
        }
    ...
    class C16399 implements OnTouchListener {
        C16399() {
        }
    ...
    static {
        entryDispatcher = new ConsoleEntryDispatcher(new C16311());
    }
    ...
    private static void init(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        ...
        Log.m626d(Tags.PLUGIN, "Tried to initialize plugin on the secondary thread. Scheduling on UI-thread...", new Object[0]);
        ThreadUtils.runOnUIThread(new C16322(activity, version, capacity, trim, pluginImp));
    }

    private static void init0(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        try {
            if (instance == null) {
                Log.m626d(Tags.PLUGIN, "Initializing plugin instance (%s): %d", version, Integer.valueOf(capacity));
                instance = new ConsolePlugin(activity, version, capacity, trim, pluginImp);
                instance.enableGestureRecognition();
                return;
            }
            Log.m632w("Plugin instance already initialized", new Object[0]);
        } catch (Throwable e) {
            Log.m628e(e, "Can't initialize plugin instance", new Object[0]);
        }
    }
    ...
    public static void shutdown() {
        ...
        Log.m626d(Tags.PLUGIN, "Tried to shutdown plugin on the secondary thread. Scheduling on UI-thread...", new Object[0]);
        ThreadUtils.runOnUIThread(new C16333());
    }
    ...
    private static void shutdown0() {
        try {
            ...
            Log.m628e(e, "Error while shutting down the plugin", new Object[0]);
        }
    }
    ...
    public static void show() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C16344());
        }
    }
    ...
    private static void show0() {
        if (instance != null) {
            ...
            Log.m632w("Can't show console: instance is not initialized", new Object[0]);
        }
    }
    ...
    public static void hide() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C16355());
        }
    }
    ...
    private static void hide0() {
        if (instance != null) {
            ...
            Log.m632w("Can't hide console: instance is not initialized", new Object[0]);
        }
    }
    ...
    public static void clear() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C16366());
        }
    }
    ...
    private ConsolePlugin(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        if (activity == null) {
            ...
            this.gestureDetector.setListener(new C16377());
        }
    }
    ...
    public void destroy() {
        ...
        Log.m626d(Tags.PLUGIN, "Plugin destroyed", new Object[0]);
    }
    ...
    private boolean showConsole() {
        try {
            if (this.consoleView == null) {
                Log.m626d(Tags.CONSOLE, "Show console", new Object[0]);
                Activity activity = getActivity();
                if (activity == null) {
                    Log.m627e("Can't show console: activity reference is lost", new Object[0]);
                    return false;
                }
                ...
                this.consoleView.startAnimation(AnimationUtils.loadAnimation(activity, C1628R.anim.lunar_console_slide_in_top));
                disableGestureRecognition();
                return true;
            }
            Log.m632w("Console is show already", new Object[0]);
            return false;
        } catch (Throwable e) {
            Log.m628e(e, "Can't show console", new Object[0]);
            return false;
        }
    }
    ...
    private boolean hideConsole() {
        try {
            ...
            Log.m626d(Tags.CONSOLE, "Hide console", new Object[0]);
            Activity activity = getActivity();
            if (activity != null) {
                Animation animation = AnimationUtils.loadAnimation(activity, C1628R.anim.lunar_console_slide_out_top);
                animation.setAnimationListener(new C16388());
            ...
            Log.m628e(e, "Can't hide console", new Object[0]);
            return false;
        }
    }
    ...
    private void removeConsoleView() {
        if (this.consoleView != null) {
            ...
            if (parent instanceof ViewGroup) {
                ...
                Log.m627e("Can't remove console view: unexpected parent " + parent, new Object[0]);
            }
    ...
    private void clearConsole() {
        try {
            ...
            Log.m628e(e, "Can't clear console", new Object[0]);
        }
    }
    ...
    private void showWarning(String message) {
        try {
            if (this.warningView == null) {
                Log.m626d(Tags.WARNING_VIEW, "Show warning", new Object[0]);
                Activity activity = getActivity();
                if (activity == null) {
                    Log.m627e("Can't show warning: activity reference is lost", new Object[0]);
                    return;
                }
                FrameLayout rootLayout = UIUtils.getRootLayout(activity);
            ...
            Log.m628e(e, "Can't show warning", new Object[0]);
        }
    }

    private void hideWarning() {
        if (this.warningView != null) {
            Log.m626d(Tags.WARNING_VIEW, "Hide warning", new Object[0]);
            ViewParent parent = this.warningView.getParent();
            if (parent instanceof ViewGroup) {
                ((ViewGroup) parent).removeView(this.warningView);
            } else {
                Log.m627e("Can't hide warning view: unexpected parent view " + parent, new Object[0]);
            }
    ...
    public void enableGestureRecognition() {
        Log.m626d(Tags.GESTURES, "Enable gesture recognition", new Object[0]);
        View view = this.pluginImp.getTouchRecepientView();
        if (view == null) {
            Log.m632w("Can't enable gesture recognition: touch view is null", new Object[0]);
        } else {
            view.setOnTouchListener(new C16399());
        }
    }

    public void disableGestureRecognition() {
        Log.m626d(Tags.GESTURES, "Disable gesture recognition", new Object[0]);
        View view = this.pluginImp.getTouchRecepientView();
        if (view != null) {
            view.setOnTouchListener(null);
        } else {
            Log.m632w("Can't disable gesture recognition: touch view is null", new Object[0]);
        }
    }
