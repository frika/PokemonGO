...
public class BasicNetwork implements Network {
    ...
    static {
        ...
        DEFAULT_POOL_SIZE = MpegAudioHeader.MAX_FRAME_SIZE_BYTES;
    }
    ...
    L_0x00fd:
        ...
        r7 = r27.getUrl();
        r4[r5] = r7;
        com.mopub.volley.VolleyLog.m486e(r3, r4);
    ...
    protected void logError(String what, String url, long start) {
        ...
        VolleyLog.m488v("HTTP ERROR(%s) %d ms to fetch %s", what, Long.valueOf(now - start), url);
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            buffer = this.mPool.getBuf(Place.TYPE_SUBLOCALITY_LEVEL_2);
            while (true) {
            ...
            try {
                ...
                VolleyLog.m488v("Error occured when calling consumingContent", new Object[0]);
            }
