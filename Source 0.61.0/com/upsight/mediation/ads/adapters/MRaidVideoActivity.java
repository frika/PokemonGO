...
public class MRaidVideoActivity extends Activity implements OnCompletionListener, OnErrorListener, OnPreparedListener {
    ...
    class C12162 implements Runnable {
        C12162() {
        }
    ...
    private void addCloseRegion() {
        ...
        this.closeRegion.setOnClickListener(new C12151());
        this.closeRegion.setVisibility(4);
        if (this.closeButtonDelay != -1) {
            this.closeRegion.postDelayed(new C12162(), this.closeButtonDelay);
        }
        Drawable closeButtonNormalDrawable = MRaidDrawables.getDrawableForImage(this, "/assets/drawable/close_button_normal.png", "close_button_normal", ViewCompat.MEASURED_STATE_MASK);
        Drawable closeButtonPressedDrawable = MRaidDrawables.getDrawableForImage(this, "/assets/drawable/close_button_pressed.png", "close_button_pressed", ViewCompat.MEASURED_STATE_MASK);
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        FuseLog.m609w(TAG, "ERROR LOADING VIDEO!");
