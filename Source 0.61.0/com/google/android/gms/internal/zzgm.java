...
public class zzgm implements Callable<zzhs> {
    ...
    class C07101 implements zzdk {
        final /* synthetic */ zzbb zzDK;
        final /* synthetic */ zzb zzDL;
        final /* synthetic */ zzin zzDM;
        final /* synthetic */ zzgm zzDN;

        C07101(zzgm com_google_android_gms_internal_zzgm, zzbb com_google_android_gms_internal_zzbb, zzb com_google_android_gms_internal_zzgm_zzb, zzin com_google_android_gms_internal_zzin) {
    ...
    class C07112 implements Runnable {
        ...
        C07112(zzgm com_google_android_gms_internal_zzgm, zzin com_google_android_gms_internal_zzin, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class C07123 implements zzdk {
        final /* synthetic */ zzgm zzDN;
        final /* synthetic */ zzf zzDQ;

        C07123(zzgm com_google_android_gms_internal_zzgm, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class C07134 implements com.google.android.gms.internal.zzip.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgm zzDN;
        ...
        C07134(zzgm com_google_android_gms_internal_zzgm, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDR = str;
            this.zzDS = num;
            this.zzDT = num2;
        ...
        public com.google.android.gms.ads.internal.formats.zza zzf(List<zzc> list) {
            ...
            if (list != null) {
                try {
                    if (!list.isEmpty()) {
                        com_google_android_gms_ads_internal_formats_zza = new com.google.android.gms.ads.internal.formats.zza(this.zzDR, zzgm.zzd((List) list), this.zzDS, this.zzDT, this.zzDU > 0 ? Integer.valueOf(this.zzDU) : null, this.zzDV + this.zzDW);
    ...
    class C07145 implements com.google.android.gms.internal.zzih.zza<zzc> {
        final /* synthetic */ String zzAs;
        final /* synthetic */ zzgm zzDN;
        final /* synthetic */ boolean zzDX;
        final /* synthetic */ double zzDY;

        C07145(zzgm com_google_android_gms_internal_zzgm, boolean z, double d, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDX = z;
            this.zzDY = d;
            this.zzAs = str;
    ...
    private com.google.android.gms.ads.internal.formats.zzh.zza zza(zzbb com_google_android_gms_internal_zzbb, zza com_google_android_gms_internal_zzgm_zza, JSONObject jSONObject) throws ExecutionException, InterruptedException, JSONException {
        ...
        if (zza == null) {
            com.google.android.gms.ads.internal.util.client.zzb.m483e("Failed to retrieve ad assets.");
            return null;
        }
    ...
    private zziq<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzio(new zzc(null, Uri.parse(string), optDouble)) : this.zzDF.zza(string, new C07145(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzbb com_google_android_gms_internal_zzbb) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdk c07123 = new C07123(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgm_zzb.zzDZ = c07123;
            com_google_android_gms_internal_zzbb.zza("/nativeAdCustomClick", c07123);
        }
    }
    ...
    private JSONObject zzb(zzbb com_google_android_gms_internal_zzbb) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgm_zzb = new zzb(this);
        zzdk c07101 = new C07101(this, com_google_android_gms_internal_zzbb, com_google_android_gms_internal_zzgm_zzb, com_google_android_gms_internal_zzin);
        com_google_android_gms_internal_zzgm_zzb.zzDZ = c07101;
        com_google_android_gms_internal_zzbb.zza("/nativeAdPreProcess", c07101);
    ...
    protected zza zzd(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzin com_google_android_gms_internal_zzin = new zzin();
            zzid.zzIE.post(new C07112(this, com_google_android_gms_internal_zzin, string2));
            if (com_google_android_gms_internal_zzin.get(zzDE, TimeUnit.MILLISECONDS) != null) {
                return new zzgp(z);
            }
            com.google.android.gms.ads.internal.util.client.zzb.m483e("No handler for custom template: " + jSONObject.getString("custom_template_id"));
        } else {
            zzC(0);
        }
        return null;
    ...
    public zziq<com.google.android.gms.ads.internal.formats.zza> zze(JSONObject jSONObject) throws JSONException {
        ...
        String optString = optJSONObject.optString(PendingDialog.TEXT);
        ...
        return zzip.zza(zzip.zzh(arrayList), new C07134(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
