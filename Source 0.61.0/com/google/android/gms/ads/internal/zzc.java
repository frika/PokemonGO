...
public abstract class zzc extends zzb implements zzg, zzfi {
    ...
    class C03601 implements Runnable {
        ...
        C03601(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    class C03632 implements Runnable {
        ...
        class C03611 implements OnTouchListener {
            final /* synthetic */ zze zzoE;
            final /* synthetic */ C03632 zzoF;

            C03611(C03632 c03632, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c03632;
        ...
        class C03622 implements OnClickListener {
            final /* synthetic */ zze zzoE;
            final /* synthetic */ C03632 zzoF;

            C03622(C03632 c03632, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c03632;
                this.zzoE = com_google_android_gms_ads_internal_zze;
            }
        ...
        C03632(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
            this.zzoC = com_google_android_gms_ads_internal_zzc;
            this.zzoB = com_google_android_gms_internal_zzhs_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C03611(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C03622(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C03601(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        ...
        zzid.zzIE.post(new C03632(this, com_google_android_gms_internal_zzhs_zza, com_google_android_gms_internal_zzcg));
    }
