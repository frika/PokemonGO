...
public class AsyncListUtil<T> {
    ...
    class C01241 implements MainThreadCallback<T> {
        C01241() {
        }
    ...
    class C01252 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C01241();
        this.mBackgroundCallback = new C01252();
        this.mTClass = klass;
