...
public class zzo {
    ...
    class C03711 implements Runnable {
        ...
        C03711(zzo com_google_android_gms_ads_internal_zzo, WeakReference weakReference) {
    ...
    zzo(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzo_zza) {
        ...
        this.zzx = new C03711(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
