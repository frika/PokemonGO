...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
    ...
    static class C14651 implements OnSubscribe<T> {
        final /* synthetic */ AtomicReference val$curr;

        C14651(AtomicReference atomicReference) {
    ...
    static class C14672 implements OnSubscribe<R> {
        ...
        class C14661 extends Subscriber<R> {
            final /* synthetic */ Subscriber val$child;
            final /* synthetic */ OnSubscribePublishMulticast val$op;

            C14661(Subscriber subscriber, OnSubscribePublishMulticast onSubscribePublishMulticast) {
        ...
        C14672(boolean z, Func1 func1, Observable observable) {
        ...
        public void call(Subscriber<? super R> child) {
            ...
            Subscriber<R> subscriber = new C14661(child, op);
            child.add(op);
    ...
    static final class PublishSubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        class C14681 implements Action0 {
            C14681() {
            }
        ...
        void init() {
            add(Subscriptions.create(new C14681()));
        }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source) {
        ...
        return new OperatorPublish(new C14651(curr), source, curr);
    }
    ...
    public static <T, R> Observable<R> create(Observable<? extends T> source, Func1<? super Observable<T>, ? extends Observable<R>> selector, boolean delayError) {
        return Observable.create(new C14672(delayError, selector, source));
    }
