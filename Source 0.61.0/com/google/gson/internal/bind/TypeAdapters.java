...
public final class TypeAdapters {
    ...
    static class C08871 extends TypeAdapter<Class> {
        C08871() {
        }
    ...
    static class C08892 extends TypeAdapter<BitSet> {
        C08892() {
        }
    ...
    static class AnonymousClass35 implements TypeAdapterFactory {
        ...
        class C08901 extends TypeAdapter<T1> {
        ...
        public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
            ...
            if (this.val$clazz.isAssignableFrom(requestedType)) {
                return new C08901(requestedType);
            }
            return null;
        }
    ...
    static class C08913 extends TypeAdapter<Boolean> {
        C08913() {
        }
    ...
    static class C08924 extends TypeAdapter<Boolean> {
        C08924() {
        }
    ...
    static class C08935 extends TypeAdapter<Number> {
        C08935() {
        }
    ...
    static class C08946 extends TypeAdapter<Number> {
        C08946() {
        }
    ...
    static class C08957 extends TypeAdapter<Number> {
        C08957() {
        }
    ...
    static class C08968 extends TypeAdapter<AtomicInteger> {
        C08968() {
        }
    ...
    static class C08979 extends TypeAdapter<AtomicBoolean> {
        C08979() {
        }
    ...
    static {
        ...
        ATOMIC_INTEGER = new C08968().nullSafe();
        ATOMIC_INTEGER_FACTORY = newFactory(AtomicInteger.class, ATOMIC_INTEGER);
        ATOMIC_BOOLEAN = new C08979().nullSafe();
        ...
        TIMESTAMP_FACTORY = new TypeAdapterFactory() {
            ...
            class C08881 extends TypeAdapter<Timestamp> {
                final /* synthetic */ TypeAdapter val$dateTypeAdapter;

                C08881(TypeAdapter typeAdapter) {
            ...
            public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
                ...
                return new C08881(gson.getAdapter(Date.class));
            }
        };
