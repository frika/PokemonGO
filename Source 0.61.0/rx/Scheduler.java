...
public abstract class Scheduler {
    ...
    public static abstract class Worker implements Subscription {
        ...
        class C13301 implements Action0 {
            ...
            C13301(long j, long j2, MultipleAssignmentSubscription multipleAssignmentSubscription, Action0 action0, long j3) {
        ...
        public Subscription schedulePeriodically(Action0 action, long initialDelay, long period, TimeUnit unit) {
            ...
            Action0 recursiveAction = new C13301(firstNowNanos, firstStartInNanos, mas, action, periodInNanos);
