...
public final class PublishSubject<T> extends Subject<T, T> {
    ...
    static class C16151 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ SubjectSubscriptionManager val$state;

        C16151(SubjectSubscriptionManager subjectSubscriptionManager) {
    ...
    public static <T> PublishSubject<T> create() {
        ...
        state.onTerminated = new C16151(state);
