...
public class MRaidAdAdapter extends NetworkWrapperFuseInternal implements MRAIDNativeFeatureListener, MRAIDInterstitialListener {
    ...
    public void mraidInterstitialLoaded(MRAIDInterstitial mraidInterstitial) {
        if (this.shouldPreload) {
            FuseLog.m608v(TAG, "MRAID Ad Loaded");
            this.loaded = true;
            onAdLoaded();
            return;
        }
    ...
    public void mraidInterstitialShow(MRAIDInterstitial mraidInterstitial) {
        FuseLog.m608v(TAG, "MRAID Ad Displayed");
        onAdDisplayed();
    ...
    public void mraidInterstitialHide(MRAIDInterstitial mraidInterstitial) {
        ...
        FuseLog.m608v(TAG, "MRAID Ad Hidden");
    ...
    public void mraidInterstitialFailedToLoad(MRAIDInterstitial mraidInterstitial) {
        FuseLog.m604d(TAG, "MRAID Ad Failed to Load");
    ...
    public void mraidNativeFeatureCallTel(String url) {
        FuseLog.m608v(TAG, "MRAID Ad Wants to make phone call " + url);
    }

    public void mraidNativeFeatureCreateCalendarEvent(String eventJSON) {
        FuseLog.m608v(TAG, "MRAID Ad Wants to create calendar event: " + eventJSON);
    }

    public void mraidNativeFeaturePlayVideo(String url) {
        FuseLog.m608v(TAG, "MRAID Ad Wants to play video: " + url);
        MRaidActivity displayedActivity = getMRaidActivity();
        if (displayedActivity != null) {
    ...
    public void mraidNativeFeatureOpenBrowser(String url) {
        FuseLog.m608v(TAG, "Ad Wants to display browser: " + url);
    ...
    public void mraidNativeFeatureOpenMarket(String url) {
        FuseLog.m608v(TAG, "Ad Wants to display market: " + url);
        if (this.clickBeacon != null) {
            sendRequestToBeacon(this.clickBeacon);
        }
        onAdClicked();
    ...
    public void mraidNativeFeatureStorePicture(String url) {
        FuseLog.m608v(TAG, "Ad Wants to store a picture: " + url);
    }

    public void mraidNativeFeatureSendSms(String url) {
        FuseLog.m608v(TAG, "Ad Wants to send SMS: " + url);
    }
