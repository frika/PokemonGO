...
abstract class Atom {
    ...
    static {
        ...
        TYPE_name = Util.getIntegerCodeForString(Twitter.NAME);
        TYPE_data = Util.getIntegerCodeForString(ModelColumns.DATA);
    ...
    public static String getAtomTypeString(int type) {
        return BuildConfig.FLAVOR + ((char) (type >> 24)) + ((char) ((type >> LONG_HEADER_SIZE) & NalUnitUtil.EXTENDED_SAR)) + ((char) ((type >> HEADER_SIZE) & NalUnitUtil.EXTENDED_SAR)) + ((char) (type & NalUnitUtil.EXTENDED_SAR));
    }
}
