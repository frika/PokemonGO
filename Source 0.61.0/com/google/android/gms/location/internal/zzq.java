...
public class zzq implements SettingsApi {
    ...
    class C08261 extends zza<LocationSettingsResult> {
        final /* synthetic */ LocationSettingsRequest zzaFP;
        final /* synthetic */ String zzaFQ;
        final /* synthetic */ zzq zzaFR;

        C08261(zzq com_google_android_gms_location_internal_zzq, GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
    ...
    public PendingResult<LocationSettingsResult> zza(GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
        return googleApiClient.zza(new C08261(this, googleApiClient, locationSettingsRequest, str));
    }
}
