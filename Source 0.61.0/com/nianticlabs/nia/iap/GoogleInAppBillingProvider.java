...
public class GoogleInAppBillingProvider implements InAppBillingProvider {
    ...
    private int billingServiceVersion;
    ...
    class C09441 implements ServiceConnection {
        ...
        class C09421 implements Runnable {
            ...
            public void run() {
                ...
                try {
                    boolean z;
                    GoogleInAppBillingProvider.this.billingServiceVersion = GoogleInAppBillingProvider.DESIRED_BILLING_SERVICE_VERSION;
                    int response = GoogleInAppBillingProvider.this.billingService.isBillingSupported(GoogleInAppBillingProvider.this.billingServiceVersion, GoogleInAppBillingProvider.this.packageName, GoogleInAppBillingProvider.ITEM_TYPE_INAPP);
                    if (response != 0) {
                        GoogleInAppBillingProvider.this.billingServiceVersion = GoogleInAppBillingProvider.DEFAULT_BILLING_SERVICE_VERSION;
                        response = GoogleInAppBillingProvider.this.billingService.isBillingSupported(GoogleInAppBillingProvider.this.billingServiceVersion, GoogleInAppBillingProvider.this.packageName, GoogleInAppBillingProvider.ITEM_TYPE_INAPP);
                    }
        ...
        class C09432 implements Runnable {
            C09432() {
            }
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ContextService.runOnServiceHandler(new C09421(service));
        }

        public void onServiceDisconnected(ComponentName name) {
            ContextService.runOnServiceHandler(new C09432());
        }
    }
    ...
    class C09463 implements Runnable {
        ...
        C09463(int i, int i2, String str, String str2) {
    ...
    private class ConsumeItemTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (this.billingService != null) {
                try {
                    num = Integer.valueOf(this.billingService.consumePurchase(GoogleInAppBillingProvider.this.billingServiceVersion, GoogleInAppBillingProvider.this.packageName, this.purchaseToken));
                } catch (RemoteException e) {
                }
            }
            return num;
    ...
    private class GetSkuDetailsTask extends AsyncTask<Void, Void, Bundle> {
        ...
        protected Bundle doInBackground(Void... params) {
            ...
            if (this.billingService != null) {
                try {
                    bundle = this.billingService.getSkuDetails(GoogleInAppBillingProvider.this.billingServiceVersion, GoogleInAppBillingProvider.this.packageName, GoogleInAppBillingProvider.ITEM_TYPE_INAPP, this.requestBundle);
                } catch (RemoteException e) {
                }
            }
            return bundle;
    ...
    private class ProcessPurchasedItemsTask extends AsyncTask<Void, Void, Bundle> {
        ...
        L_0x0006:
            ...
            r2 = 0;
        L_0x0009:
            r8 = r12.billingService;	 Catch:{ RemoteException -> 0x0078 }
            r9 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.this;	 Catch:{ RemoteException -> 0x0078 }
            r9 = r9.billingServiceVersion;	 Catch:{ RemoteException -> 0x0078 }
            r10 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.this;	 Catch:{ RemoteException -> 0x0078 }
            r10 = r10.packageName;	 Catch:{ RemoteException -> 0x0078 }
            r11 = "inapp";
            r3 = r8.getPurchases(r9, r10, r11, r2);	 Catch:{ RemoteException -> 0x0078 }
            r5 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.getResponseCodeFromBundle(r3);	 Catch:{ RemoteException -> 0x0078 }
            r8 = "INAPP_PURCHASE_DATA_LIST";
            r4 = r3.getStringArrayList(r8);	 Catch:{ RemoteException -> 0x0078 }
            r8 = "INAPP_DATA_SIGNATURE_LIST";
            r7 = r3.getStringArrayList(r8);	 Catch:{ RemoteException -> 0x0078 }
            r8 = 5;
        ...
        L_0x0044:
            r8 = "INAPP_PURCHASE_DATA_LIST";
            r8 = r3.containsKey(r8);	 Catch:{ RemoteException -> 0x0078 }
        ...
        L_0x004c:
            ...
            if (r8 == 0) goto L_0x0030;
        L_0x0054:
            r8 = r4.size();	 Catch:{ RemoteException -> 0x0078 }
            r9 = r7.size();	 Catch:{ RemoteException -> 0x0078 }
        ...
        L_0x0062:
            ...
            r2 = r3.getString(r8);	 Catch:{ RemoteException -> 0x0078 }
            if (r2 == 0) goto L_0x0030;
        L_0x006a:
            r8 = r2.length();	 Catch:{ RemoteException -> 0x0078 }
            if (r8 != 0) goto L_0x0009;
        L_0x0070:
            goto L_0x0030;
        L_0x0071:
            r0.addAll(r4);	 Catch:{ RemoteException -> 0x0078 }
            r1.addAll(r7);	 Catch:{ RemoteException -> 0x0078 }
            goto L_0x0062;
        L_0x0078:
            r8 = move-exception;
            goto L_0x0030;
        ...
        protected void onPostExecute(Bundle result) {
            if (result != null) {
                ContextService.runOnServiceHandler(new C09471(result));
                return;
            }
            GoogleInAppBillingProvider.this.finalizeConnectionResult();
            GoogleInAppBillingProvider.this.maybeDisconnectBillingService();
    ...
    public GoogleInAppBillingProvider(Context context) {
        ...
        this.billingServiceVersion = DEFAULT_BILLING_SERVICE_VERSION;
    ...
    private void connectToBillingService() {
        if (!this.connectionInProgress) {
            ...
            this.serviceConnection = new C09441();
    ...
    public void purchaseItem(String itemId, String developerPayload) {
        ...
        if (!isBillingAvailable()) {
            ...
            try {
                ...
                if (this.billingServiceVersion == DESIRED_BILLING_SERVICE_VERSION) {
                    Bundle extras = new Bundle();
                    extras.putString("accountId", developerPayload);
                    buyIntentBundle = this.billingService.getBuyIntentExtraParams(this.billingServiceVersion, this.packageName, itemId, ITEM_TYPE_INAPP, developerPayload, extras);
                } else {
                    buyIntentBundle = this.billingService.getBuyIntent(this.billingServiceVersion, this.packageName, itemId, ITEM_TYPE_INAPP, developerPayload);
                }
    ...
    private void launchPurchaseActivity(PendingIntent pendingIntent) {
        ...
        ContextService.runOnUiThread(new C09452());
    }
    ...
    public void forwardedOnActivityResult(int resultCode, Intent data) {
        ...
        ContextService.runOnServiceHandler(new C09463(resultCode, responseCode, purchaseData, dataSignature));
    }
    ...
    private boolean handlePurchaseErrorResult(int resultCode) {
        switch (resultCode) {
            ...
            case BILLING_RESPONSE_RESULT_USER_CANCELED /*1*/:
                finalizePurchaseResult(PurchaseResult.USER_CANCELLED);
                break;
            case DEFAULT_BILLING_SERVICE_VERSION /*3*/:
                finalizePurchaseResult(PurchaseResult.BILLING_UNAVAILABLE);
                break;
    ...
    private static int getResponseCodeFromObject(Object responseObject) {
        ...
        return DESIRED_BILLING_SERVICE_VERSION;
    }
}
