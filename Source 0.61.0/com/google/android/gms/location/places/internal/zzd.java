...
public class zzd implements GeoDataApi {
    ...
    class C08291 extends zzc<zze> {
        final /* synthetic */ AddPlaceRequest zzaGV;
        final /* synthetic */ zzd zzaGW;

        C08291(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, AddPlaceRequest addPlaceRequest) {
    ...
    class C08302 extends zzc<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String[] zzaGX;

        C08302(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String[] strArr) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaGX = strArr;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    class C08313 extends zza<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ LatLngBounds zzaGY;
        final /* synthetic */ AutocompleteFilter zzaGZ;
        final /* synthetic */ String zzaxk;

        C08313(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str, LatLngBounds latLngBounds, AutocompleteFilter autocompleteFilter) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaxk = str;
    ...
    class C08324 extends zzb<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String zzaHa;

        C08324(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaHa = str;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    public PendingResult<PlaceBuffer> addPlace(GoogleApiClient client, AddPlaceRequest addPlaceRequest) {
        return client.zzb(new C08291(this, Places.zzaGz, client, addPlaceRequest));
    }
    ...
    public PendingResult<AutocompletePredictionBuffer> getAutocompletePredictions(GoogleApiClient client, String query, LatLngBounds bounds, AutocompleteFilter filter) {
        return client.zza(new C08313(this, Places.zzaGz, client, query, bounds, filter));
    }
    ...
    public PendingResult<PlaceBuffer> getPlaceById(GoogleApiClient client, String... placeIds) {
        ...
        zzx.zzaa(z);
        return client.zza(new C08302(this, Places.zzaGz, client, placeIds));
    }

    public PendingResult<PlacePhotoMetadataResult> getPlacePhotos(GoogleApiClient client, String placeId) {
        return client.zza(new C08324(this, Places.zzaGz, client, placeId));
    }
}
