...
public class GoogleUnityActivity extends Activity {
    ...
    class C08991 implements OnTouchListener {
        C08991() {
        }
    ...
    class C09002 implements OnGenericMotionListener {
        C09002() {
        }
    ...
    class C09013 implements OnKeyListener {
        C09013() {
        }
    ...
    class C09045 implements OnSystemUiVisibilityChangeListener {
        ...
        C09045(Handler handler) {
            this.val$handler = handler;
        }

        public void onSystemUiVisibilityChange(int visibility) {
            if ((visibility & 2) == 0) {
                this.val$handler.postDelayed(new C09031(), 2000);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mUnityPlayer.setOnTouchListener(new C08991());
        this.mUnityPlayer.setOnGenericMotionListener(new C09002());
        this.mUnityPlayer.setOnKeyListener(new C09013());
    ...
    public void showAndroidViewLayer(int layoutResId) {
        runOnUiThread(new C09024(this, layoutResId));
    }
    ...
    private void startImmersiveMode() {
        getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new C09045(new Handler()));
    }
