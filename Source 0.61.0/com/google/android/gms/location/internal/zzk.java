...
public class zzk {
    ...
    private static class zza extends com.google.android.gms.location.zzc.zza {
        ...
        class C08251 extends Handler {
            ...
            C08251(zza com_google_android_gms_location_internal_zzk_zza, Looper looper, LocationCallback locationCallback) {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case C1628R.styleable.RecyclerView_android_orientation /*0*/:
                        this.zzaFh.onLocationResult((LocationResult) msg.obj);
                    case C1628R.styleable.RecyclerView_layoutManager /*1*/:
                        this.zzaFh.onLocationAvailability((LocationAvailability) msg.obj);
                    default:
                }
            }
        }
        ...
        zza(LocationCallback locationCallback, Looper looper) {
            ...
            this.zzaFy = new C08251(this, looper, locationCallback);
        }
    ...
    private static class zzb extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case C1628R.styleable.RecyclerView_layoutManager /*1*/:
                    this.zzaFA.onLocationChanged(new Location((Location) msg.obj));
                default:
