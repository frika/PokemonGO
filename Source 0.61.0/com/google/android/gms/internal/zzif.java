...
public class zzif {
    ...
    class C07421 implements OnClickListener {
        ...
        C07421(zzif com_google_android_gms_internal_zzif, String str) {
    ...
    class C07432 implements OnClickListener {
        ...
        C07432(zzif com_google_android_gms_internal_zzif) {
            this.zzIN = com_google_android_gms_internal_zzif;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C07421(this, zzaD));
            builder.setNegativeButton("Close", new C07432(this));
            builder.create().show();
            return;
        }
