...
public abstract class UnsafeAllocator {
    ...
    static class C08741 extends UnsafeAllocator {
        final /* synthetic */ Method val$allocateInstance;
        final /* synthetic */ Object val$unsafe;

        C08741(Method method, Object obj) {
    ...
    static class C08752 extends UnsafeAllocator {
        final /* synthetic */ int val$constructorId;
        final /* synthetic */ Method val$newInstance;

        C08752(Method method, int i) {
    ...
    static class C08763 extends UnsafeAllocator {
        final /* synthetic */ Method val$newInstance;

        C08763(Method method) {
            this.val$newInstance = method;
        }
    ...
    static class C08774 extends UnsafeAllocator {
        C08774() {
        }
    ...
    public static UnsafeAllocator create() {
        ...
        try {
            ...
            return new C08741(unsafeClass.getMethod("allocateInstance", new Class[]{Class.class}), f.get(null));
        } catch (Exception e) {
            try {
