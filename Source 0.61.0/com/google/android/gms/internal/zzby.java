...
public final class zzby {
    ...
    static {
        ...
        zzuD = zzbu.zza("gads:video_stream_cache:connect_timeout_millis", (int) AdaptiveEvaluator.DEFAULT_MIN_DURATION_FOR_QUALITY_INCREASE_MS);
        ...
        zzvv = zzbu.zzb("gads:ad_loader:timeout_ms", HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS);
        zzvw = zzbu.zzb("gads:rendering:timeout_ms", HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS);
