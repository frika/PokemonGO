...
public class BillboardManagementActivity extends Activity {
    ...
    static /* synthetic */ class C11721 {
        static final /* synthetic */ int[] f725x10de5d48;

        static {
            f725x10de5d48 = new int[PresentationStyle.values().length];
            try {
                f725x10de5d48[PresentationStyle.Dialog.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f725x10de5d48[PresentationStyle.Fullscreen.ordinal()] = 2;
    ...
    static {
        STYLE_DIALOG = C1162R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_UpsightDialog;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extension != null) {
            ...
            setContentView(C1162R.layout.upsight_activity_billboard_management);
            String id = getIntent().getStringExtra(INTENT_EXTRA_MARKETING_CONTENT_ID);
            this.mUpsight.getLogger().m574d(LOG_TAG, "onCreate activity=" + this + " marketingContentId=" + id, new Object[STYLE_DIALOG]);
    ...
    protected void onResume() {
        ...
        if (content != null) {
            ...
            this.mUpsight.getLogger().m574d(LOG_TAG, "onResume activity=" + this + " eventQueueSize=" + eventQueue.size(), new Object[STYLE_DIALOG]);
    ...
    protected void onPause() {
        this.mIsForeground = false;
        this.mUpsight.getLogger().m574d(LOG_TAG, "onPause activity=" + this, new Object[STYLE_DIALOG]);
        super.onPause();
    }
    ...
    protected void onDestroy() {
        ...
        this.mUpsight.getLogger().m574d(LOG_TAG, "onDestroy activity=" + this, new Object[STYLE_DIALOG]);
        super.onDestroy();
    }
    ...
    public void handleAvailabilityEvent(SubcontentAvailabilityEvent event) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Received SubcontentAvailabilityEvent activity=" + this + " marketingContentId=" + event.getId(), new Object[STYLE_DIALOG]);
    ...
    public void handleAvailabilityEvent(SubdialogAvailabilityEvent event) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Received SubdialogAvailabilityEvent activity=" + this + " marketingContentId=" + event.getId(), new Object[STYLE_DIALOG]);
        if (this.mIsForeground) {
            handle(event);
            return;
        }
    ...
    public void handleAvailabilityEvent(ScopelessAvailabilityEvent event) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Received ScopelessAvailabilityEvent activity=" + this + " marketingContentId=" + event.getId(), new Object[STYLE_DIALOG]);
        if (this.mIsForeground) {
            handle(event);
            return;
        }
    ...
    public void handleActionEvent(DestroyEvent event) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Received DestroyEvent activity=" + this + " marketingContentId=" + event.mId, new Object[STYLE_DIALOG]);
        if (this.mIsForeground) {
            handle(event);
            return;
        }
    ...
    public void onApplicationStatus(ApplicationStatus appStatus) {
        if (appStatus.getState() == State.BACKGROUND) {
            this.mUpsight.getLogger().m574d(LOG_TAG, "Received application background event activity=" + this, new Object[STYLE_DIALOG]);
            MarketingContent content = this.mContent;
            if (content != null) {
    ...
    void attachDialog(PendingDialog pendingDialog) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Attach dialog activity=" + this + " marketingContentId=" + pendingDialog.mId, new Object[STYLE_DIALOG]);
        Intent intent = getIntent();
        if (intent.hasExtra(INTENT_EXTRA_MARKETING_CONTENT_DIALOG_THEME)) {
            BillboardDialogFragment.newInstance(pendingDialog, intent.getIntExtra(INTENT_EXTRA_MARKETING_CONTENT_DIALOG_THEME, Cue.TYPE_UNSET)).show(getFragmentManager(), null);
        } else {
    ...
    void attachBillboard(MarketingContent content) {
        this.mUpsight.getLogger().m574d(LOG_TAG, "Attach billboard activity=" + this + " marketingContentId=" + content.getId(), new Object[STYLE_DIALOG]);
        UpsightContentMediator<?> mediator = content.getContentMediator();
        if (mediator != null) {
            int style;
            ...
            switch (C11721.f725x10de5d48[preferredStyle.ordinal()]) {
    ...
    void detachBillboard() {
        Billboard billboard = this.mBillboard;
        if (billboard != null) {
            this.mUpsight.getLogger().m574d(LOG_TAG, "Detach billboard activity=" + this + " scope=" + billboard.getScope(), new Object[STYLE_DIALOG]);
