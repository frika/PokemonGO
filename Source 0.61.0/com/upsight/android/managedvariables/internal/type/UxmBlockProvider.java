...
public class UxmBlockProvider extends AbstractUxmBlockProvider implements OnSharedPreferenceChangeListener {
    ...
    class C11411 implements Observer {
        C11411() {
        }
    ...
    UxmBlockProvider(UpsightContext upsight, @Named("stringRawUxmSchema") String uxmSchemaRawString, UxmSchema uxmSchema) {
        this.mBundleHashObserver = new C11411();
        ...
        try {
            ...
            upsight.getLogger().m577e(Upsight.LOG_TAG, e, "Failed to generate UXM hashes because SHA-1 is unavailable on this device", new Object[0]);
        }
    ...
    private static String bytesToHex(byte[] bytes) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            int v = bytes[i] & NalUnitUtil.EXTENDED_SAR;
