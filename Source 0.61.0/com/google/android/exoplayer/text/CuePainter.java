...
final class CuePainter {
    ...
    public CuePainter(Context context) {
        ...
        int twoDpInPx = Math.round((Default.HTTP_REQUEST_BACKOFF_MULT * ((float) context.getResources().getDisplayMetrics().densityDpi)) / 160.0f);
    ...
    private void drawLayout(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            if (this.edgeType == 1) {
                ...
                float offset = this.shadowRadius / Default.HTTP_REQUEST_BACKOFF_MULT;
