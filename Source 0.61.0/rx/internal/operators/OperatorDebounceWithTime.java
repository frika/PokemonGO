...
public final class OperatorDebounceWithTime<T> implements Operator<T, T> {
    ...
    class C14291 extends Subscriber<T> {
        ...
        class C14281 implements Action0 {
            ...
            public void call() {
                C14291.this.state.emit(this.val$index, C14291.this.val$s, C14291.this.self);
            }
        }

        C14291(Subscriber x0, SerialSubscription serialSubscription, Worker worker, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            this.val$ssub.set(this.val$worker.schedule(new C14281(this.state.next(t)), OperatorDebounceWithTime.this.timeout, OperatorDebounceWithTime.this.unit));
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        s.add(worker);
        s.add(ssub);
        return new C14291(child, ssub, worker, s);
    }
}
