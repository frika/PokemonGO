...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
    ...
    class C02841 implements Runnable {
        ...
        C02841(DecoderInitializationException decoderInitializationException) {
    ...
    class C02852 implements Runnable {
        ...
        C02852(CryptoException cryptoException) {
    ...
    class C02863 implements Runnable {
        ...
        C02863(String str, long j, long j2) {
    ...
    private void notifyDecoderInitializationError(DecoderInitializationException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02841(e));
        }
    }

    private void notifyCryptoError(CryptoException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02852(e));
        }
    }

    private void notifyDecoderInitialized(String decoderName, long initializedTimestamp, long initializationDuration) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C02863(decoderName, initializedTimestamp, initializationDuration));
        }
    }
