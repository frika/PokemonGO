...
public class MRAIDInterstitial implements MRAIDViewListener {
    ...
    class C12191 implements Runnable {
        ...
        public void run() {
            if (!MRAIDInterstitial.this.isReady || MRAIDInterstitial.this.listener == null) {
                MRAIDLog.m616i(MRAIDInterstitial.TAG, "No longer ready");
            } else {
    ...
    public boolean show() {
        ...
        MRAIDLog.m616i(TAG, "interstitial is not ready to show");
        return false;
    }
    ...
    public void mraidViewLoaded(MRAIDView mraidView) {
        MRAIDLog.m618v("MRAIDInterstitial-MRAIDViewListener", "mraidViewLoaded");
        this.isReady = true;
        this.handler.postDelayed(new C12191(), 250);
    }

    public void mraidViewExpand(MRAIDView mraidView) {
        MRAIDLog.m616i("MRAIDInterstitial-MRAIDViewListener", "mraidViewExpand");
    ...
    public void mraidViewClose(MRAIDView mraidView) {
        MRAIDLog.m616i("MRAIDInterstitial-MRAIDViewListener", "mraidViewClose");
        this.isReady = false;
        if (this.listener != null) {
