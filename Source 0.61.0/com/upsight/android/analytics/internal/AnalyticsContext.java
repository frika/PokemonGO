...
public class AnalyticsContext extends ContextWrapper {
    ...
    public String getDefaultDispatcherConfiguration() {
        try {
            return IOUtils.toString(getResources().openRawResource(C1061R.raw.dispatcher_config));
        } catch (IOException e) {
            this.mUpsight.getLogger().m576e(LOG_TAG, "Could not read default configuration.", e);
            return null;
        }
    }
}
