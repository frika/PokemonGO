...
public final class LocationRequest implements SafeParcelable {
    ...
    public LocationRequest() {
        ...
        this.zzasP = false;
        this.zzaEj = PtsTimestampAdjuster.DO_NOT_OFFSET;
    ...
    public LocationRequest setExpirationDuration(long millis) {
        ...
        if (millis > PtsTimestampAdjuster.DO_NOT_OFFSET - elapsedRealtime) {
            this.zzaEj = PtsTimestampAdjuster.DO_NOT_OFFSET;
        } else {
    ...
    public String toString() {
        ...
        if (this.zzaEj != PtsTimestampAdjuster.DO_NOT_OFFSET) {
