...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C15381 implements Action0 {
            ...
            C15381(OperatorWindowWithTime operatorWindowWithTime) {
        ...
        class C15392 implements Action0 {
            C15392() {
            }
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> child, Worker worker) {
            ...
            child.add(Subscriptions.create(new C15381(OperatorWindowWithTime.this)));
        }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C15392(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C15412 implements Action0 {
            final /* synthetic */ CountedSerializedSubject val$chunk;

            C15412(CountedSerializedSubject countedSerializedSubject) {
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C15401(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    this.worker.schedule(new C15412(chunk), OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
                } catch (Throwable e) {
                    onError(e);
                }
            }
