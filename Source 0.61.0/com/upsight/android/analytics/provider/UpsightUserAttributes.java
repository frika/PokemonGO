...
public abstract class UpsightUserAttributes {
    ...
    public static void put(UpsightSessionContext upsight, String key, String value) throws IllegalArgumentException {
        put(upsight.getUpsightContext(), key, value);
    }

    public static void put(UpsightSessionContext upsight, String key, Integer value) throws IllegalArgumentException {
        put(upsight.getUpsightContext(), key, value);
    }

    public static void put(UpsightSessionContext upsight, String key, Boolean value) throws IllegalArgumentException {
        put(upsight.getUpsightContext(), key, value);
    }

    public static void put(UpsightSessionContext upsight, String key, Float value) throws IllegalArgumentException {
        put(upsight.getUpsightContext(), key, value);
    }

    public static void put(UpsightSessionContext upsight, String key, Date value) throws IllegalArgumentException {
        put(upsight.getUpsightContext(), key, value);
    }

    public static String getString(UpsightSessionContext upsight, String key) {
        return getString(upsight.getUpsightContext(), key);
    }

    public static Integer getInteger(UpsightSessionContext upsight, String key) {
        return getInteger(upsight.getUpsightContext(), key);
    }

    public static Boolean getBoolean(UpsightSessionContext upsight, String key) {
        return getBoolean(upsight.getUpsightContext(), key);
    }

    public static Float getFloat(UpsightSessionContext upsight, String key) {
        return getFloat(upsight.getUpsightContext(), key);
    }

    public static Date getDatetime(UpsightSessionContext upsight, String key) {
        return getDatetime(upsight.getUpsightContext(), key);
    }

    public static Set<Entry> getDefault(UpsightSessionContext upsight) {
        return getDefault(upsight.getUpsightContext());
    }
}
