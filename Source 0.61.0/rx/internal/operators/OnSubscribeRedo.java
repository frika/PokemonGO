...
public final class OnSubscribeRedo<T> implements OnSubscribe<T> {
    ...
    static class C13981 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        /* renamed from: rx.internal.operators.OnSubscribeRedo.1.1 */
        class C13971 implements Func1<Notification<?>, Notification<?>> {
            C13971() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C13971());
        }
    }

    /* renamed from: rx.internal.operators.OnSubscribeRedo.2 */
    class C14002 implements Action0 {
        ...
        class C13991 extends Subscriber<T> {
            ...
            public void onCompleted() {
                if (!this.done) {
                    this.done = true;
                    unsubscribe();
                    C14002.this.val$terminals.onNext(Notification.createOnCompleted());
                }
            }
            ...
            public void onError(Throwable e) {
                if (!this.done) {
                    this.done = true;
                    unsubscribe();
                    C14002.this.val$terminals.onNext(Notification.createOnError(e));
                }
            }

            public void onNext(T v) {
                if (!this.done) {
                    C14002.this.val$child.onNext(v);
                    decrementConsumerCapacity();
                    C14002.this.val$arbiter.produced(1);
                }
            }
            ...
            private void decrementConsumerCapacity() {
                long cc;
                do {
                    cc = C14002.this.val$consumerCapacity.get();
                    if (cc == PtsTimestampAdjuster.DO_NOT_OFFSET) {
                        return;
                    }
                } while (!C14002.this.val$consumerCapacity.compareAndSet(cc, cc - 1));
            }

            public void setProducer(Producer producer) {
                C14002.this.val$arbiter.setProducer(producer);
            }
        }

        C14002(Subscriber subscriber, BehaviorSubject behaviorSubject, ProducerArbiter producerArbiter, AtomicLong atomicLong, SerialSubscription serialSubscription) {
        ...
        public void call() {
            if (!this.val$child.isUnsubscribed()) {
                Subscriber<T> terminalDelegatingSubscriber = new C13991();
    ...
    class C14023 implements Operator<Notification<?>, Notification<?>> {

        /* renamed from: rx.internal.operators.OnSubscribeRedo.3.1 */
        class C14011 extends Subscriber<Notification<?>> {
            ...
            public void setProducer(Producer producer) {
                producer.request(PtsTimestampAdjuster.DO_NOT_OFFSET);
            }
        }
        ...
        public Subscriber<? super Notification<?>> call(Subscriber<? super Notification<?>> filteredTerminals) {
            return new C14011(filteredTerminals, filteredTerminals);
        }
    }

    /* renamed from: rx.internal.operators.OnSubscribeRedo.4 */
    class C14044 implements Action0 {
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ AtomicLong val$consumerCapacity;
        ...
        class C14031 extends Subscriber<Object> {
            C14031(Subscriber x0) {
                super(x0);
            }

            public void onCompleted() {
                C14044.this.val$child.onCompleted();
            }

            public void onError(Throwable e) {
                C14044.this.val$child.onError(e);
            }

            public void onNext(Object t) {
                if (!C14044.this.val$child.isUnsubscribed()) {
                    if (C14044.this.val$consumerCapacity.get() > 0) {
                        C14044.this.val$worker.schedule(C14044.this.val$subscribeToSource);
                    } else {
                        C14044.this.val$resumeBoundary.compareAndSet(false, true);
                    }
                }
            }
        ...
        C14044(Observable observable, Subscriber subscriber, AtomicLong atomicLong, Worker worker, Action0 action0, AtomicBoolean atomicBoolean) {
        ...
        public void call() {
            this.val$restarts.unsafeSubscribe(new C14031(this.val$child));
        }
    }

    /* renamed from: rx.internal.operators.OnSubscribeRedo.5 */
    class C14055 implements Producer {
        final /* synthetic */ ProducerArbiter val$arbiter;
        final /* synthetic */ AtomicLong val$consumerCapacity;
        final /* synthetic */ AtomicBoolean val$resumeBoundary;
        final /* synthetic */ Action0 val$subscribeToSource;
        ...
        C14055(AtomicLong atomicLong, ProducerArbiter producerArbiter, AtomicBoolean atomicBoolean, Worker worker, Action0 action0) {
            this.val$consumerCapacity = atomicLong;
            this.val$arbiter = producerArbiter;
            this.val$resumeBoundary = atomicBoolean;
            this.val$worker = worker;
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C14061 implements Func1<Notification<?>, Notification<?>> {
            int num;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C14061()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C14071 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C14071() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C14071());
        }
    }

    static {
        REDO_INFINITE = new C13981();
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new C14002(child, terminals, arbiter, consumerCapacity, sourceSubscriptions);
        worker.schedule(new C14044((Observable) this.controlHandlerFunction.call(terminals.lift(new C14023())), child, consumerCapacity, worker, subscribeToSource, atomicBoolean));
        child.setProducer(new C14055(consumerCapacity, arbiter, atomicBoolean, worker, subscribeToSource));
    }
}
