...
public final class Gson {
    ...
    class C08481 implements JsonDeserializationContext {
        C08481() {
        }
    ...
    class C08492 implements JsonSerializationContext {
        C08492() {
        }
    ...
    class C08503 extends TypeAdapter<Number> {
        C08503() {
        }
    ...
    class C08514 extends TypeAdapter<Number> {
        C08514() {
        }
    ...
    static class C08525 extends TypeAdapter<Number> {
        C08525() {
        }
    ...
    static class C08536 extends TypeAdapter<AtomicLong> {
        final /* synthetic */ TypeAdapter val$longAdapter;

        C08536(TypeAdapter typeAdapter) {
    ...
    static class C08547 extends TypeAdapter<AtomicLongArray> {
        final /* synthetic */ TypeAdapter val$longAdapter;

        C08547(TypeAdapter typeAdapter) {
            this.val$longAdapter = typeAdapter;
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingPolicy, Map<Type, InstanceCreator<?>> instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization, boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean lenient, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> typeAdapterFactories) {
        ...
        this.deserializationContext = new C08481();
        this.serializationContext = new C08492();
