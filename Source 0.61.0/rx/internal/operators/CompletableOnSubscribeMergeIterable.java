...
public final class CompletableOnSubscribeMergeIterable implements CompletableOnSubscribe {
    ...
    class C13851 implements CompletableSubscriber {
        ...
        C13851(CompositeSubscription compositeSubscription, AtomicBoolean atomicBoolean, CompletableSubscriber completableSubscriber, AtomicInteger atomicInteger) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new C13851(set, once, s, wip));
                                } else {
                                    return;
                                }
                            } catch (Throwable e) {
