...
public final class OperatorSampleWithObservable<T, U> implements Operator<T, T> {
    ...
    class C14811 extends Subscriber<U> {
        ...
        C14811(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, AtomicReference atomicReference2) {
    ...
    class C14822 extends Subscriber<T> {
        final /* synthetic */ SerializedSubscriber val$s;
        final /* synthetic */ Subscriber val$samplerSub;
        final /* synthetic */ AtomicReference val$value;

        C14822(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, Subscriber subscriber) {
            this.val$value = atomicReference;
            this.val$s = serializedSubscriber;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<U> samplerSub = new C14811(value, s, main);
        Subscriber<T> result = new C14822(value, s, samplerSub);
        main.lazySet(result);
        child.add(result);
