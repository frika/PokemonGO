...
public final class zzli extends GoogleApiClient {
    ...
    class C07691 implements zze {
        final /* synthetic */ zzli zzacr;

        C07691(zzli com_google_android_gms_internal_zzli) {
    ...
    class C07702 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;

        C07702(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
        ...
        public void onConnected(Bundle connectionHint) {
            ...
            try {
                this.zzacr.zzacj.onConnected(connectionHint);
            } finally {
        ...
        public void onConnectionSuspended(int cause) {
            this.zzacr.zzabt.lock();
            try {
                this.zzacr.zzacj.onConnectionSuspended(cause);
            } finally {
                this.zzacr.zzabt.unlock();
            }
        }
    ...
    class C07713 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzli zzacr;

        C07713(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C07724 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ Api zzacs;
        final /* synthetic */ int zzact;

        C07724(zzli com_google_android_gms_internal_zzli, Api api, int i) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacs = api;
            this.zzact = i;
        }
        ...
        public void onConnectionFailed(ConnectionResult result) {
            this.zzacr.zzabt.lock();
            try {
                this.zzacr.zzacj.zza(result, this.zzacs, this.zzact);
            } finally {
                this.zzacr.zzabt.unlock();
            }
        }
    ...
    class C07735 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ AtomicReference zzacu;
        final /* synthetic */ zzlo zzacv;

        C07735(zzli com_google_android_gms_internal_zzli, AtomicReference atomicReference, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    class C07746 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;

        C07746(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
        }
    ...
    class C07757 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzWT;
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;
        final /* synthetic */ boolean zzacw;

        C07757(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo, boolean z, GoogleApiClient googleApiClient) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
            this.zzacw = z;
    ...
    class C07768 implements Runnable {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ FragmentActivity zzacx;

        C07768(zzli com_google_android_gms_internal_zzli, FragmentActivity fragmentActivity) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    public zzli(Context context, Looper looper, com.google.android.gms.common.internal.zzf com_google_android_gms_common_internal_zzf, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzqw, zzqx> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzqw__com_google_android_gms_internal_zzqx, Map<Api<?>, ApiOptions> map, ArrayList<ConnectionCallbacks> arrayList, ArrayList<OnConnectionFailedListener> arrayList2, int i) {
        ...
        this.zzacc = 120000;
        this.zzacd = HlsChunkSource.DEFAULT_MIN_BUFFER_TO_SWITCH_UP_MS;
        this.zzacg = new HashMap();
        this.zzach = new HashMap();
        this.zzaci = new HashSet();
        this.zzack = null;
        this.zzacl = Collections.newSetFromMap(new WeakHashMap());
        this.zzacm = Collections.newSetFromMap(new ConcurrentHashMap(16, PlayerControls.DOWN_STATE, 2));
        this.zzaco = new C07691(this);
        this.zzacp = new C07702(this);
        this.zzacq = new C07713(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzlo com_google_android_gms_internal_zzlo, boolean z) {
        zzlx.zzagw.zzb(googleApiClient).setResultCallback(new C07757(this, com_google_android_gms_internal_zzlo, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzacg.containsKey(zzlx.zzRk)) {
            ...
            ConnectionCallbacks c07735 = new C07735(this, atomicReference, com_google_android_gms_internal_zzlo);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzlx.API).addConnectionCallbacks(c07735).addOnConnectionFailedListener(new C07746(this, com_google_android_gms_internal_zzlo)).setHandler(this.zzace).build();
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        for (Api api : this.zzabJ.keySet()) {
            writer.append(prefix).append(api.getName()).println(UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR);
    ...
    public void stopAutoManage(FragmentActivity lifecycleActivity) {
        if (this.zzaaM >= 0) {
            zzlp zza = zzlp.zza(lifecycleActivity);
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C07768(this, lifecycleActivity));
                return;
            } else {
                zza.zzbp(this.zzaaM);
                return;
