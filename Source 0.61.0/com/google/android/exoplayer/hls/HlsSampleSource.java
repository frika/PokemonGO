...
public final class HlsSampleSource implements SampleSource, SampleSourceReader, Callback {
    ...
    class C03121 implements Runnable {
        ...
        C03121(long j, int i, int i2, Format format, long j2, long j3) {
            this.val$length = j;
            this.val$type = i;
            this.val$trigger = i2;
    ...
    class C03132 implements Runnable {
        ...
        C03132(long j, int i, int i2, Format format, long j2, long j3, long j4, long j5) {
    ...
    class C03154 implements Runnable {
        ...
        C03154(IOException iOException) {
    ...
    class C03165 implements Runnable {
        ...
        C03165(Format format, int i, long j) {
            this.val$format = format;
            this.val$trigger = i;
    ...
    public int readData(int track, long playbackPositionUs, MediaFormatHolder formatHolder, SampleHolder sampleHolder) {
        ...
        if (mediaFormat != null && !mediaFormat.equals(this.downstreamMediaFormats[track])) {
            ...
            sampleHolder.flags = (decodeOnly ? C0277C.SAMPLE_FLAG_DECODE_ONLY : PRIMARY_TYPE_NONE) | sampleHolder.flags;
            return -3;
    ...
    private void notifyLoadStarted(long length, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03121(length, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs));
        }
    }
    ...
    private void notifyLoadCompleted(long bytesLoaded, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03132(bytesLoaded, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs, elapsedRealtimeMs, loadDurationMs));
        }
    }

    private void notifyLoadCanceled(long bytesLoaded) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03143(bytesLoaded));
        }
    }

    private void notifyLoadError(IOException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03154(e));
        }
    }

    private void notifyDownstreamFormatChanged(Format format, int trigger, long positionUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C03165(format, trigger, positionUs));
        }
    }
}
