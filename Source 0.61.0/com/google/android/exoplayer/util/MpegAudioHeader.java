...
public final class MpegAudioHeader {
    ...
    static {
        ...
        BITRATE_V1_L1 = new int[]{32, 64, 96, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, 288, 320, 352, 384, 416, 448};
        BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, 112, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 144, 160, 176, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY};
        BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, 112, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, 320, 384};
        BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, 320};
        BITRATE_V2 = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 144, 160};
    }
    ...
    public static int getFrameSize(int header) {
        ...
        if (layer == 3) {
            return ((((version == 3 ? BITRATE_V1_L1[bitrateIndex - 1] : BITRATE_V2_L1[bitrateIndex - 1]) * SafetyNetStatusCodes.SAFE_BROWSING_UNSUPPORTED_THREAT_TYPES) / samplingRate) + padding) * 4;
        }
    ...
    public static boolean populateHeader(int headerData, MpegAudioHeader header) {
        ...
        header.setValues(version, MIME_TYPE_BY_LAYER[3 - layer], frameSize, sampleRate, ((headerData >> 6) & 3) == 3 ? 1 : 2, bitrate * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE, samplesPerFrame);
        return true;
    }
