...
public class UnityVrActivityListener implements AndroidInputListener {
    ...
    class C09162 implements Runnable {
        final /* synthetic */ long val$time;
        final /* synthetic */ int val$x;
        final /* synthetic */ int val$y;

        C09162(int i, int i2, long j) {
            this.val$x = i;
            this.val$y = i2;
            this.val$time = j;
        }
    ...
    class C09173 implements Runnable {
    ...
    public UnityVrActivityListener() {
        ...
        this.touchX = 0;
        this.touchY = 0;
        this.vrBackButtonListener = new C09151();
    ...
    public void injectSingleTap() {
        if (!this.tapInProgress) {
            ...
            int x = this.touchX;
            int y = this.touchY;
            this.unityActivity.getUnityPlayer().postDelayed(new C09162(x, y, injectTouchDown(x, y)), TAP_TIME_MS);
        }
    }
    ...
    public void injectKeyPress(int keyCode) {
        ...
        this.unityActivity.getUnityPlayer().postDelayed(new C09173(keyCode), TAP_TIME_MS);
    }
}
