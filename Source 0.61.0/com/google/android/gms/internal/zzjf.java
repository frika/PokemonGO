...
public class zzjf extends WebChromeClient {
    ...
    static class C07541 implements OnCancelListener {
        final /* synthetic */ JsResult zzKD;

        C07541(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C07552 implements OnClickListener {
        final /* synthetic */ JsResult zzKD;

        C07552(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C07563 implements OnClickListener {
        final /* synthetic */ JsResult zzKD;

        C07563(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C07574 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzKE;

        C07574(JsPromptResult jsPromptResult) {
    ...
    static class C07585 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzKE;

        C07585(JsPromptResult jsPromptResult) {
            this.zzKE = jsPromptResult;
        }
    ...
    static class C07596 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzKE;
        final /* synthetic */ EditText zzKF;

        C07596(JsPromptResult jsPromptResult, EditText editText) {
            this.zzKE = jsPromptResult;
            this.zzKF = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C07563(jsResult)).setNegativeButton(17039360, new C07552(jsResult)).setOnCancelListener(new C07541(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C07596(jsPromptResult, editText)).setNegativeButton(17039360, new C07585(jsPromptResult)).setOnCancelListener(new C07574(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C07607.zzKG[consoleMessage.messageLevel().ordinal()]) {
