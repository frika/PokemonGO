...
public class BlockingSingle<T> {
    ...
    class C16121 extends SingleSubscriber<T> {
        final /* synthetic */ CountDownLatch val$latch;
        final /* synthetic */ AtomicReference val$returnException;
        final /* synthetic */ AtomicReference val$returnItem;

        C16121(AtomicReference atomicReference, CountDownLatch countDownLatch, AtomicReference atomicReference2) {
    ...
    public T value() {
        ...
        BlockingUtils.awaitForComplete(latch, this.single.subscribe(new C16121(returnItem, latch, returnException)));
