...
public class zzaz implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C06221 implements zzc<zzbe> {
        final /* synthetic */ JSONObject zzrv;
        final /* synthetic */ zzaz zzrw;

        C06221(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
    ...
    class C06232 implements zza {
        final /* synthetic */ zzaz zzrw;

        C06232(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06243 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;

        C06243(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06254 implements zza {
        final /* synthetic */ zzaz zzrw;

        C06254(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06265 extends BroadcastReceiver {
        final /* synthetic */ zzaz zzrw;

        C06265(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06276 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C06276(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06287 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C06287(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06298 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C06298(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C06309 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;
        final /* synthetic */ JSONObject zzrx;

        C06309(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
            this.zzrw = com_google_android_gms_internal_zzaz;
    ...
    public zzaz(AdSizeParcel adSizeParcel, zzhs com_google_android_gms_internal_zzhs, VersionInfoParcel versionInfoParcel, View view, zzdz com_google_android_gms_internal_zzdz) {
        ...
        this.zzrs = new C06276(this);
        this.zzrt = new C06287(this);
        this.zzru = new C06298(this);
        ...
        try {
            this.zzrg.zza(new C06221(this, zzd(view)), new C06232(this));
        } catch (JSONException e) {
        } catch (Throwable e2) {
            zzb.zzb("Failure while processing active view data.", e2);
        }
        this.zzrg.zza(new C06243(this), new C06254(this));
    ...
    protected void zza(JSONObject jSONObject) {
        try {
            ...
            this.zzrg.zza(new C06309(this, jSONObject2), new zzis.zzb());
        } catch (Throwable th) {
