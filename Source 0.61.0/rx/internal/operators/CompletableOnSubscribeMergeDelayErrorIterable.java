...
public final class CompletableOnSubscribeMergeDelayErrorIterable implements CompletableOnSubscribe {
    ...
    class C13841 implements CompletableSubscriber {
        ...
        C13841(CompositeSubscription compositeSubscription, Queue queue, AtomicInteger atomicInteger, CompletableSubscriber completableSubscriber) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new C13841(set, queue, wip, s));
                                } else {
                                    return;
                                }
