...
public final class FrameworkSampleSource implements SampleSource, SampleSourceReader {
    ...
    private static MediaFormat createMediaFormat(MediaFormat format) {
        ...
        MediaFormat mediaFormat = new MediaFormat(null, mimeType, -1, maxInputSize, durationUs, width, height, rotationDegrees, -1.0f, channelCount, sampleRate, language, PtsTimestampAdjuster.DO_NOT_OFFSET, initializationData, false, -1, -1, encoderDelay, encoderPadding);
