...
public class zzh {
    ...
    class C03341 implements zzdk {
        final /* synthetic */ zzh zzwO;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzh.1.1 */
        class C03331 implements com.google.android.gms.internal.zzja.zza {
            final /* synthetic */ Map zzwP;
            final /* synthetic */ C03341 zzwQ;

            C03331(C03341 c03341, Map map) {
                this.zzwQ = c03341;
                this.zzwP = map;
            }
        ...
        C03341(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
            this.zzwO.zzoM.zzhe().zza(new C03331(this, map));
            String str = (String) map.get("overlayHtml");
            String str2 = (String) map.get(NetworkWrapper.BASE_URL);
            if (TextUtils.isEmpty(str2)) {
                this.zzwO.zzoM.loadData(str, Mime.HTML_TEXT, C0277C.UTF8_NAME);
            } else {
                this.zzwO.zzoM.loadDataWithBaseURL(str2, str, Mime.HTML_TEXT, C0277C.UTF8_NAME, null);
            }
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.formats.zzh.2 */
    class C03352 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C03352(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C03363 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C03363(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C03374 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C03374(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C03385 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C03385(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zziz zzdC() {
        ...
        this.zzwJ.zza("/loadHtml", new C03341(this));
        this.zzwJ.zza("/showOverlay", new C03352(this));
        this.zzwJ.zza("/hideOverlay", new C03363(this));
        this.zzoM.zzhe().zza("/hideOverlay", new C03374(this));
        this.zzoM.zzhe().zza("/sendMessageToSdk", new C03385(this));
        return this.zzoM;
    }
