...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C05981 implements zzf<T> {
        final /* synthetic */ zza zzapr;

        C05981(zza com_google_android_gms_dynamic_zza) {
    ...
    class C05992 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Activity zzaps;
        final /* synthetic */ Bundle zzapt;
        final /* synthetic */ Bundle zzapu;

        C05992(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzaps = activity;
            this.zzapt = bundle;
            this.zzapu = bundle2;
    ...
    class C06003 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Bundle zzapu;

        C06003(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzapu = bundle;
        }
    ...
    class C06014 implements zza {
        ...
        C06014(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
    ...
    static class C06025 implements OnClickListener {
        final /* synthetic */ int zzapy;
        final /* synthetic */ Context zzry;

        C06025(Context context, int i) {
            this.zzry = context;
            this.zzapy = i;
        }
    ...
    class C06036 implements zza {
        final /* synthetic */ zza zzapr;

        C06036(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    class C06047 implements zza {
        final /* synthetic */ zza zzapr;

        C06047(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    public static void zzb(FrameLayout frameLayout) {
        ...
        if (zzh != null) {
            ...
            button.setOnClickListener(new C06025(context, isGooglePlayServicesAvailable));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new C06003(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new C06014(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzapn == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new C05992(this, activity, attrs, savedInstanceState));
    }
