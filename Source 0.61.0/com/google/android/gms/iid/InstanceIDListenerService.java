...
public class InstanceIDListenerService extends Service {
    ...
    class C06171 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzaDJ;

        C06171(InstanceIDListenerService instanceIDListenerService, Looper looper) {
            this.zzaDJ = instanceIDListenerService;
            super(looper);
        }

        public void handleMessage(Message msg) {
            this.zzaDJ.zza(msg, MessengerCompat.zzc(msg));
        }
    }

    /* renamed from: com.google.android.gms.iid.InstanceIDListenerService.2 */
    class C06182 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaDJ;

        C06182(InstanceIDListenerService instanceIDListenerService) {
            this.zzaDJ = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaDD = new MessengerCompat(new C06171(this, Looper.getMainLooper()));
        this.zzaDE = new C06182(this);
    }
