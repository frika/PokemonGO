...
public class UxmModule {
    ...
    String provideUxmSchemaRawString(UpsightContext upsight, @Named("resUxmSchema") Integer uxmSchemaRes) {
        ...
        try {
            ...
            logger.m576e(Upsight.LOG_TAG, "Failed to find UXM schema file", new Object[0]);
            return schemaString;
        } catch (IOException e) {
            logger.m577e(Upsight.LOG_TAG, e, "Failed to read UXM schema file", new Object[0]);
            return schemaString;
        }
    }
    ...
    UxmSchema provideUxmSchema(UpsightContext upsight, @Named("gsonUxmSchema") Gson uxmSchemaGson, @Named("jsonParserUxmSchema") JsonParser uxmSchemaJsonParser, @Named("stringRawUxmSchema") String uxmSchemaString) {
        ...
        if (!TextUtils.isEmpty(uxmSchemaString)) {
            try {
                ...
                logger.m577e(Upsight.LOG_TAG, e, "Failed to parse UXM schema", new Object[0]);
            }
        }
        if (schema != null) {
            return schema;
        ...
        logger.m574d(Upsight.LOG_TAG, "Empty UXM schema used", new Object[0]);
        return schema;
    }
